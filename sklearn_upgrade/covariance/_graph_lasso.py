...
from sklearn_upgrade.covariance import EmpiricalCovariance, empirical_covariance, log_likelihood
...
from sklearn_upgrade.model_selection import check_cv, cross_val_score
...
def graphical_lasso(
    ...
    *,
    ...
    >>> from sklearn_upgrade.covariance import empirical_covariance, graphical_lasso
...
class GraphicalLasso(BaseGraphicalLasso):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.covariance import GraphicalLasso
...
class GraphicalLassoCV(BaseGraphicalLasso):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.covariance import GraphicalLassoCV
    >>> true_cov = np.array([[0.8, 0.0, 0.2, 0.0],
    ...                      [0.0, 0.4, 0.0, 0.0],
    ...                      [0.2, 0.0, 0.3, 0.1],
    ...                      [0.0, 0.0, 0.1, 0.7]])
    ...
    For an example comparing :class:`sklearn_upgrade.covariance.GraphicalLassoCV`,
    :func:`sklearn_upgrade.covariance.ledoit_wolf` shrinkage and the empirical covariance
