...
from sklearn_upgrade.covariance._empirical_covariance import (
    EmpiricalCovariance,
...
# exported by sklearn_upgrade.covariance. Deprecate?
def c_step(
    X,
    n_support,
    ...
    cov_computation_method : callable, \
            default=:func:`sklearn_upgrade.covariance.empirical_covariance`
...
class MinCovDet(EmpiricalCovariance):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.covariance import MinCovDet
