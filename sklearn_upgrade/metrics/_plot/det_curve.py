...
from sklearn_upgrade.metrics._ranking import det_curve
...
class DetCurveDisplay(_BinaryClassifierCurveDisplayMixin):
    ...
    It is recommended to use :func:`~sklearn_upgrade.metrics.DetCurveDisplay.from_estimator`
    or :func:`~sklearn_upgrade.metrics.DetCurveDisplay.from_predictions` to create a
    ...
    >>> from sklearn_upgrade.metrics import det_curve, DetCurveDisplay
    ...
    def from_estimator(
        ...
        **kwargs : dict
        ...
        Returns
        -------
        display : :class:`~sklearn_upgrade.metrics.DetCurveDisplay`
        ...
        >>> import matplotlib.pyplot as plt
        >>> from sklearn_upgrade.datasets import make_classification
        >>> from sklearn_upgrade.metrics import DetCurveDisplay
        >>> from sklearn_upgrade.model_selection import train_test_split
        >>> from sklearn_upgrade.svm import SVC
        >>> X, y = make_classification(n_samples=1000, random_state=0)
        >>> X_train, X_test, y_train, y_test = train_test_split(
