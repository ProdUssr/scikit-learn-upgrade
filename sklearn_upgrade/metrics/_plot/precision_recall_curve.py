...
from sklearn_upgrade.metrics._ranking import average_precision_score, precision_recall_curve
from sklearn_upgrade.utils import _safe_indexing, check_array
...
class PrecisionRecallDisplay(_BinaryClassifierCurveDisplayMixin):
    ...
    :func:`~sklearn_upgrade.metrics.PrecisionRecallDisplay.from_estimator` or
    :func:`~sklearn_upgrade.metrics.PrecisionRecallDisplay.from_predictions` to create
    a :class:`~sklearn_upgrade.metrics.PrecisionRecallDisplay`. All parameters are
    ...
    Notes
    -----
    The average precision (cf. :func:`~sklearn_upgrade.metrics.average_precision_score`) in
    ...
    def plot(
        ...
        **kwargs : dict
        ...
        Returns
        -------
        display : :class:`~sklearn_upgrade.metrics.PrecisionRecallDisplay`
            Object that stores computed values.

        Notes
        -----
        The average precision (cf. :func:`~sklearn_upgrade.metrics.average_precision_score`)
    ...
    def from_estimator(
        ...
        **kwargs : dict
        ...
        >>> import matplotlib.pyplot as plt
        >>> from sklearn_upgrade.datasets import make_classification
        >>> from sklearn_upgrade.metrics import PrecisionRecallDisplay
        >>> from sklearn_upgrade.model_selection import train_test_split
    ...
    def from_cv_results(
        ...
        *,
        ...
        ----------
        cv_results : dict
            Dictionary as returned by :func:`~sklearn_upgrade.model_selection.cross_validate`
