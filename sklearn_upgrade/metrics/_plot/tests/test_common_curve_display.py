...
from sklearn_upgrade.datasets import load_breast_cancer, load_iris, make_classification
...
from sklearn_upgrade.model_selection import cross_validate, train_test_split
