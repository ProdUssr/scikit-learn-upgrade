...
from sklearn_upgrade.utils._array_api import _xlogy as xlogy
...
def mean_absolute_error(
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import mean_absolute_error
    >>> y_true = [3, -0.5, 2, 7]
    >>> y_pred = [2.5, 0.0, 2, 8]
...
def mean_pinball_loss(
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import mean_pinball_loss
    >>> y_true = [1, 2, 3]
...
def mean_absolute_percentage_error(
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import mean_absolute_percentage_error
    >>> y_true = [3, -0.5, 2, 7]
    >>> y_pred = [2.5, 0.0, 2, 8]
...
def mean_squared_error(
    ...
    *,
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import mean_squared_error
    >>> y_true = [3, -0.5, 2, 7]
    >>> y_pred = [2.5, 0.0, 2, 8]
...
def root_mean_squared_error(
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import root_mean_squared_error
    >>> y_true = [3, -0.5, 2, 7]
    >>> y_pred = [2.5, 0.0, 2, 8]
...
def mean_squared_log_error(
    ...
    *,
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import mean_squared_log_error
    >>> y_true = [3, 5, 2.5, 7]
    >>> y_pred = [2.5, 5, 4, 8]
...
def root_mean_squared_log_error(
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import root_mean_squared_log_error
    >>> y_true = [3, 5, 2.5, 7]
    >>> y_pred = [2.5, 5, 4, 8]
...
def median_absolute_error(
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import median_absolute_error
    >>> y_true = [3, -0.5, 2, 7]
    >>> y_pred = [2.5, 0.0, 2, 8]
...
def explained_variance_score(
    ...
    *,
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import explained_variance_score
    >>> y_true = [3, -0.5, 2, 7]
    >>> y_pred = [2.5, 0.0, 2, 8]
...
def max_error(y_true, y_pred):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import max_error
    >>> y_true = [3, 2, 7, 1]
    >>> y_pred = [4, 2, 7, 1]
...
def mean_tweedie_deviance(y_true, y_pred, *, sample_weight=None, power=0):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import mean_tweedie_deviance
    >>> y_true = [2, 0, 1, 4]
    >>> y_pred = [0.5, 0.5, 2., 2.]
...
def mean_poisson_deviance(y_true, y_pred, *, sample_weight=None):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import mean_poisson_deviance
    >>> y_true = [2, 0, 1, 4]
    >>> y_pred = [0.5, 0.5, 2., 2.]
...
def mean_gamma_deviance(y_true, y_pred, *, sample_weight=None):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import mean_gamma_deviance
    >>> y_true = [2, 0.5, 1, 4]
    >>> y_pred = [0.5, 0.5, 2., 2.]
...
def d2_tweedie_score(y_true, y_pred, *, sample_weight=None, power=0):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import d2_tweedie_score
    >>> y_true = [0.5, 1, 2.5, 7]
    >>> y_pred = [1, 1, 5, 3.5]
...
def d2_pinball_score(
    ...
    :class:`~sklearn_upgrade.model_selection.GridSearchCV` or
    :class:`~sklearn_upgrade.model_selection.RandomizedSearchCV`.
    Instead, you can :ref:`create a scorer object <scoring_adapt_metric>` using
    :func:`~sklearn_upgrade.metrics.make_scorer`, with any desired parameter settings.
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import d2_pinball_score
    >>> y_true = [1, 2, 3]
    >>> y_pred = [1, 3, 3]
    ...
    Creating a scorer object with :func:`~sklearn_upgrade.metrics.make_scorer`:

    >>> import numpy as np
    >>> from sklearn_upgrade.metrics import make_scorer
    >>> from sklearn_upgrade.model_selection import GridSearchCV
    >>> from sklearn_upgrade.linear_model import QuantileRegressor
    >>> X = np.array([[1], [2], [3], [4]])
...
def d2_absolute_error_score(
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import d2_absolute_error_score
    >>> y_true = [3, -0.5, 2, 7]
    >>> y_pred = [2.5, 0.0, 2, 8]
