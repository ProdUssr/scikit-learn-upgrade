...
from sklearn_upgrade import config_context
from sklearn_upgrade.exceptions import DataConversionWarning
from sklearn_upgrade.metrics._pairwise_distances_reduction import ArgKmin
from sklearn_upgrade.metrics._pairwise_fast import _chi2_kernel_fast, _sparse_manhattan
from sklearn_upgrade.preprocessing import normalize
from sklearn_upgrade.utils import check_array, gen_batches, gen_even_slices
from sklearn_upgrade.utils._array_api import (
    _fill_diagonal,
...
from sklearn_upgrade.utils._chunking import get_chunk_n_rows
from sklearn_upgrade.utils._mask import _get_mask
from sklearn_upgrade.utils._missing import is_scalar_nan
...
from sklearn_upgrade.utils._sparse import _align_api_if_sparse
from sklearn_upgrade.utils.extmath import row_norms, safe_sparse_dot
from sklearn_upgrade.utils.fixes import parse_version, sp_base_version
from sklearn_upgrade.utils.parallel import Parallel, delayed
from sklearn_upgrade.utils.validation import _num_samples, check_non_negative
...
def euclidean_distances(
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics.pairwise import euclidean_distances
    >>> X = [[0, 1], [1, 1]]
...
def nan_euclidean_distances(
    ...
    * John K. Dixon, "Pattern Recognition with Partly Missing Data",
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics.pairwise import nan_euclidean_distances
    >>> nan = float("NaN")
    >>> X = [[0, 1], [1, nan]]
...
def pairwise_distances_argmin_min(
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics.pairwise import pairwise_distances_argmin_min
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def pairwise_distances_argmin(X, Y, *, axis=1, metric="euclidean", metric_kwargs=None):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics.pairwise import pairwise_distances_argmin
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def haversine_distances(X, Y=None):
    ...
    >>> from sklearn_upgrade.metrics.pairwise import haversine_distances
    ...
    array([[    0.        , 11099.54035582],
           [11099.54035582,     0.        ]])
    """
    from sklearn_upgrade.metrics import DistanceMetric
...
def manhattan_distances(X, Y=None):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics.pairwise import manhattan_distances
...
def cosine_distances(X, Y=None):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics.pairwise import cosine_distances
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def paired_euclidean_distances(X, Y):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics.pairwise import paired_euclidean_distances
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def paired_manhattan_distances(X, Y):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics.pairwise import paired_manhattan_distances
    >>> import numpy as np
...
def paired_cosine_distances(X, Y):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics.pairwise import paired_cosine_distances
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def paired_distances(X, Y, *, metric="euclidean", **kwds):
    ...
    **kwds : dict
    ...
    See Also
    --------
    sklearn_upgrade.metrics.pairwise_distances : Computes the distance between every pair of
        samples.

    Examples
    --------
    >>> from sklearn_upgrade.metrics.pairwise import paired_distances
    >>> X = [[0, 1], [1, 1]]
    >>> Y = [[0, 1], [2, 1]]
...
def linear_kernel(X, Y=None, dense_output=True):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics.pairwise import linear_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
    >>> linear_kernel(X, Y)
    array([[0., 0.],
...
def polynomial_kernel(X, Y=None, degree=3, gamma=None, coef0=1):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics.pairwise import polynomial_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def sigmoid_kernel(X, Y=None, gamma=None, coef0=1):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics.pairwise import sigmoid_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
    >>> sigmoid_kernel(X, Y)
    array([[0.76, 0.76],
...
def rbf_kernel(X, Y=None, gamma=None):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics.pairwise import rbf_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
    >>> rbf_kernel(X, Y)
    array([[0.71, 0.51],
...
def laplacian_kernel(X, Y=None, gamma=None):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics.pairwise import laplacian_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def cosine_similarity(X, Y=None, dense_output=True):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics.pairwise import cosine_similarity
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def additive_chi2_kernel(X, Y=None):
    ...
    chi2_kernel : The exponentiated version of the kernel, which is usually
        preferable.
    sklearn_upgrade.kernel_approximation.AdditiveChi2Sampler : A Fourier approximation
        to this kernel.
    ...
    * Zhang, J. and Marszalek, M. and Lazebnik, S. and Schmid, C.
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics.pairwise import additive_chi2_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def chi2_kernel(X, Y=None, gamma=1.0):
    ...
    * Zhang, J. and Marszalek, M. and Lazebnik, S. and Schmid, C.
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics.pairwise import chi2_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
    >>> chi2_kernel(X, Y)
    array([[0.368, 0.135],
...
def pairwise_distances_chunked(
    ...
    **kwds,
    ...
    working_memory : float, default=None
        ...
        ``sklearn_upgrade.get_config()['working_memory']`` is used.
    ...
    **kwds : optional keyword parameters
    ...
    >>> import numpy as np
    >>> from sklearn_upgrade.metrics import pairwise_distances_chunked
...
def pairwise_distances(
    ...
    **kwds,
    ...
    scikit-learn, see :func:`sklearn_upgrade.metrics.pairwise.distance_metrics`
    function.
    ...
    **kwds : optional keyword parameters
    ...
    sklearn_upgrade.metrics.pairwise.paired_distances : Computes the distances between
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics.pairwise import pairwise_distances
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def kernel_metrics():
    ...
    The valid distance metrics, and the function they map to, are:
      ...
      metric            Function
      ===============   ========================================
      'additive_chi2'   sklearn_upgrade.pairwise.additive_chi2_kernel
      'chi2'            sklearn_upgrade.pairwise.chi2_kernel
      'linear'          sklearn_upgrade.pairwise.linear_kernel
      'poly'            sklearn_upgrade.pairwise.polynomial_kernel
      'polynomial'      sklearn_upgrade.pairwise.polynomial_kernel
      'rbf'             sklearn_upgrade.pairwise.rbf_kernel
      'laplacian'       sklearn_upgrade.pairwise.laplacian_kernel
      'sigmoid'         sklearn_upgrade.pairwise.sigmoid_kernel
      'cosine'          sklearn_upgrade.pairwise.cosine_similarity
      ===============   ========================================
...
def pairwise_kernels(
    ...
    metric : str or callable, default="linear"
        ...
        :mod:`sklearn_upgrade.metrics.pairwise` are not allowed, as they operate on
    ...
    **kwds : optional keyword parameters
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics.pairwise import pairwise_kernels
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
    ...
    from sklearn_upgrade.gaussian_process.kernels import Kernel as GPKernel
