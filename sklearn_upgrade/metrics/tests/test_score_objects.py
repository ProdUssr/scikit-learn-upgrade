...
from sklearn_upgrade.linear_model import LogisticRegression, Perceptron, Ridge
...
from sklearn_upgrade.metrics import cluster as cluster_module
...
from sklearn_upgrade.model_selection import GridSearchCV, cross_val_score, train_test_split
...
def memmap_data_and_estimators(tmp_path_factory):
    temp_folder = tmp_path_factory.mktemp("sklearn_upgrade_test_score_objects")
