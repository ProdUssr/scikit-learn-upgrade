...
from sklearn_upgrade.metrics._base import _average_binary_score
...
from sklearn_upgrade.utils.fixes import COO_CONTAINERS, parse_version, sp_version
from sklearn_upgrade.utils.multiclass import type_of_target
from sklearn_upgrade.utils.validation import _num_samples, check_random_state
...
def precision_recall_curve_padded_thresholds(*args, **kwargs):
    ...
    :func:`sklearn_upgrade.metrics.precision_recall_curve`
