...
from sklearn_upgrade.metrics._base import _average_binary_score, _average_multiclass_ovo_score
from sklearn_upgrade.preprocessing import label_binarize
...
from sklearn_upgrade.utils._encode import _encode, _unique
...
from sklearn_upgrade.utils.sparsefuncs import count_nonzero
...
def auc(x, y):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade import metrics
...
def average_precision_score(
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.metrics import average_precision_score
...
def det_curve(
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.metrics import det_curve
    >>> y_true = np.array([0, 0, 1, 1])
    >>> y_scores = np.array([0.1, 0.4, 0.35, 0.8])
...
def roc_auc_score(
    ...
    *,
    ...
    >>> from sklearn_upgrade.metrics import roc_auc_score
    ...
    >>> import numpy as np
    >>> from sklearn_upgrade.datasets import make_multilabel_classification
    >>> from sklearn_upgrade.multioutput import MultiOutputClassifier
...
def confusion_matrix_at_thresholds(
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.metrics import confusion_matrix_at_thresholds
    >>> y_true = np.array([0., 0., 1., 1.])
    >>> y_score = np.array([0.1, 0.4, 0.35, 0.8])
...
def precision_recall_curve(
    ...
    *,
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.metrics import precision_recall_curve
    >>> y_true = np.array([0, 0, 1, 1])
    >>> y_scores = np.array([0.1, 0.4, 0.35, 0.8])
...
def label_ranking_average_precision_score(y_true, y_score, *, sample_weight=None):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.metrics import label_ranking_average_precision_score
...
def coverage_error(y_true, y_score, *, sample_weight=None):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import coverage_error
    >>> y_true = [[1, 0, 0], [0, 1, 1]]
    >>> y_score = [[1, 0, 0], [0, 1, 1]]
...
def label_ranking_loss(y_true, y_score, *, sample_weight=None):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import label_ranking_loss
    >>> y_true = [[1, 0, 0], [0, 0, 1]]
...
def dcg_score(
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.metrics import dcg_score
...
def ndcg_score(y_true, y_score, *, k=None, sample_weight=None, ignore_ties=False):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.metrics import ndcg_score
    >>> # we have ground-truth relevance of some answers to a query:
    >>> true_relevance = np.asarray([[10, 0, 0, 1, 5]])
...
def top_k_accuracy_score(
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.metrics import top_k_accuracy_score
...
def metric_at_thresholds(
    ...
    *,
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.metrics import accuracy_score, metric_at_thresholds
    >>> y_true = np.array([0, 0, 1, 1])
    >>> y_score = np.array([0.1, 0.4, 0.35, 0.8])
