...
from sklearn_upgrade.externals.array_api_compat import is_numpy_array
...
from sklearn_upgrade.utils import _safe_indexing, check_random_state, check_X_y
...
def silhouette_score(
    ...
    metric : str or callable, default='euclidean'
        ...
        allowed by :func:`~sklearn_upgrade.metrics.pairwise_distances`. If ``X`` is
    ...
    **kwds : optional keyword parameters
    ...
    >>> from sklearn_upgrade.metrics import silhouette_score
...
def silhouette_samples(X, labels, *, metric="euclidean", **kwds):
    ...
    metric : str or callable, default='euclidean'
        The metric to use when calculating distance between instances in a
        feature array. If metric is a string, it must be one of the options
        allowed by :func:`~sklearn_upgrade.metrics.pairwise_distances`.
    ...
    **kwds : optional keyword parameters
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import silhouette_samples
    >>> from sklearn_upgrade.datasets import make_blobs
    >>> from sklearn_upgrade.cluster import KMeans
...
def calinski_harabasz_score(X, labels):
    ...
    >>> from sklearn_upgrade.datasets import make_blobs
    >>> from sklearn_upgrade.cluster import KMeans
    >>> from sklearn_upgrade.metrics import calinski_harabasz_score
...
def davies_bouldin_score(X, labels):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import davies_bouldin_score
    >>> X = [[0, 1], [1, 1], [3, 4]]
    >>> labels = [0, 0, 1]
