...
from sklearn_upgrade.metrics.cluster._expected_mutual_info_fast import (
    expected_mutual_information,
)
from sklearn_upgrade.utils import _align_api_if_sparse, deprecated
...
from sklearn_upgrade.utils.validation import check_array, check_consistent_length
...
def contingency_matrix(
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics.cluster import contingency_matrix
...
def pair_confusion_matrix(labels_true, labels_pred):
    ...
    See Also
    --------
    sklearn_upgrade.metrics.rand_score : Rand Score.
    sklearn_upgrade.metrics.adjusted_rand_score : Adjusted Rand Score.
    sklearn_upgrade.metrics.adjusted_mutual_info_score : Adjusted Mutual Information.
    ...
    diagonal regardless of actual label values:
      ...
      >>> from sklearn_upgrade.metrics.cluster import pair_confusion_matrix
...
def rand_score(labels_true, labels_pred):
    ...
    Perfectly matching labelings have a score of 1 even
      ...
      >>> from sklearn_upgrade.metrics.cluster import rand_score
...
def adjusted_rand_score(labels_true, labels_pred):
    ...
    Perfectly matching labelings have a score of 1 even
      ...
      >>> from sklearn_upgrade.metrics.cluster import adjusted_rand_score
...
def homogeneity_completeness_v_measure(labels_true, labels_pred, *, beta=1.0):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import homogeneity_completeness_v_measure
...
def homogeneity_score(labels_true, labels_pred):
    ...
    Perfect labelings are homogeneous::
      ...
      >>> from sklearn_upgrade.metrics.cluster import homogeneity_score
...
def completeness_score(labels_true, labels_pred):
    ...
    Perfect labelings are complete::
      ...
      >>> from sklearn_upgrade.metrics.cluster import completeness_score
...
def v_measure_score(labels_true, labels_pred, *, beta=1.0):
    ...
    Perfect labelings are both homogeneous and complete, hence have score 1.0::
      ...
      >>> from sklearn_upgrade.metrics.cluster import v_measure_score
...
def mutual_info_score(labels_true, labels_pred, *, contingency=None):
    ...
    contingency : {array-like, sparse matrix} of shape \
        ...
        :func:`~sklearn_upgrade.metrics.cluster.contingency_matrix` function. If value
    ...
    Examples
    --------
    >>> from sklearn_upgrade.metrics import mutual_info_score
...
def adjusted_mutual_info_score(
    ...
    score 1.0::
      ...
      >>> from sklearn_upgrade.metrics.cluster import adjusted_mutual_info_score
...
def normalized_mutual_info_score(
    ...
    score 1.0::
      ...
      >>> from sklearn_upgrade.metrics.cluster import normalized_mutual_info_score
...
def fowlkes_mallows_score(labels_true, labels_pred):
    ...
    **False Negative** (i.e. the number of pairs of points that belong to the
    ...
    score 1.0::
      ...
      >>> from sklearn_upgrade.metrics.cluster import fowlkes_mallows_score
