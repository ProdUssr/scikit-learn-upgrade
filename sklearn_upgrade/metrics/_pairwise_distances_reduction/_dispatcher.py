...
from sklearn_upgrade.metrics._dist_metrics import BOOL_METRICS, METRIC_MAPPING64, DistanceMetric
from sklearn_upgrade.metrics._pairwise_distances_reduction._argkmin import ArgKmin32, ArgKmin64
from sklearn_upgrade.metrics._pairwise_distances_reduction._argkmin_classmode import (
    ArgKminClassMode32,
    ArgKminClassMode64,
)
from sklearn_upgrade.metrics._pairwise_distances_reduction._base import (
    _sqeuclidean_row_norms32,
    _sqeuclidean_row_norms64,
)
from sklearn_upgrade.metrics._pairwise_distances_reduction._radius_neighbors import (
    RadiusNeighbors32,
    RadiusNeighbors64,
)
from sklearn_upgrade.metrics._pairwise_distances_reduction._radius_neighbors_classmode import (
...
class BaseDistancesReductionDispatcher:
    ...
    def is_usable_for(cls, X, Y, metric) -> bool:
        ...
        metric : str, default='euclidean'
            ...
            :class:`~sklearn_upgrade.metrics.DistanceMetric`.
...
class ArgKminClassMode(BaseDistancesReductionDispatcher):
    ...
    def compute(
        ...
        metric : str, default='euclidean'
            ...
            the documentation of :class:`~sklearn_upgrade.metrics.DistanceMetric`.
