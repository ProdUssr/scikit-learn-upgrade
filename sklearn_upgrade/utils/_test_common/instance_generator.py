...
from sklearn_upgrade import clone, config_context
from sklearn_upgrade.calibration import CalibratedClassifierCV
from sklearn_upgrade.cluster import (
    HDBSCAN,
    AffinityPropagation,
...
from sklearn_upgrade.covariance import GraphicalLasso, GraphicalLassoCV
from sklearn_upgrade.cross_decomposition import CCA, PLSSVD, PLSCanonical, PLSRegression
from sklearn_upgrade.decomposition import (
    NMF,
    PCA,
    DictionaryLearning,
    FactorAnalysis,
...
from sklearn_upgrade.discriminant_analysis import (
    LinearDiscriminantAnalysis,
    QuadraticDiscriminantAnalysis,
)
from sklearn_upgrade.dummy import DummyClassifier
from sklearn_upgrade.ensemble import (
    AdaBoostClassifier,
    AdaBoostRegressor,
    BaggingClassifier,
    BaggingRegressor,
...
from sklearn_upgrade.exceptions import SkipTestWarning
from sklearn_upgrade.experimental import enable_halving_search_cv  # noqa: F401
from sklearn_upgrade.feature_selection import (
    RFE,
    RFECV,
    SelectFdr,
    SelectFromModel,
...
from sklearn_upgrade.kernel_approximation import (
    Nystroem,
...
from sklearn_upgrade.manifold import (
    MDS,
    TSNE,
    Isomap,
...
from sklearn_upgrade.mixture import BayesianGaussianMixture, GaussianMixture
...
from sklearn_upgrade.multiclass import (
    OneVsOneClassifier,
    OneVsRestClassifier,
    OutputCodeClassifier,
)
from sklearn_upgrade.multioutput import (
    ClassifierChain,
...
from sklearn_upgrade.neighbors import (
    KernelDensity,
...
from sklearn_upgrade.neural_network import BernoulliRBM, MLPClassifier, MLPRegressor
from sklearn_upgrade.pipeline import FeatureUnion, Pipeline
...
from sklearn_upgrade.random_projection import GaussianRandomProjection, SparseRandomProjection
from sklearn_upgrade.semi_supervised import (
    LabelPropagation,
    LabelSpreading,
    SelfTrainingClassifier,
)
from sklearn_upgrade.svm import SVC, SVR, LinearSVC, LinearSVR, NuSVC, NuSVR, OneClassSVM
from sklearn_upgrade.tree import DecisionTreeClassifier, DecisionTreeRegressor
from sklearn_upgrade.utils import all_estimators
from sklearn_upgrade.utils._tags import get_tags
from sklearn_upgrade.utils._testing import SkipTest
from sklearn_upgrade.utils.fixes import _IS_32BIT, parse_version, sp_base_version
