...
from sklearn_upgrade.utils._param_validation import Integral, Interval, validate_params
...
def single_source_shortest_path_length(graph, source, *, cutoff=None):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.utils.graph import single_source_shortest_path_length
    >>> import numpy as np
...
def _fix_connected_components(
    ...
    **kwargs,
    ...
    metric : str
        Metric used in `sklearn_upgrade.metrics.pairwise.pairwise_distances`.

    kwargs : kwargs
        Keyword arguments passed to
        `sklearn_upgrade.metrics.pairwise.pairwise_distances`.
