...
from sklearn_upgrade.utils.validation import _check_response_method, check_is_fitted
...
def _get_response_values(
    ...
    estimator : estimator instance
        ...
        fitted :class:`~sklearn_upgrade.pipeline.Pipeline` in which the last estimator is a
