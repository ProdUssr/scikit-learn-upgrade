...
from sklearn_upgrade.utils._array_api import _is_numpy_namespace, get_namespace
from sklearn_upgrade.utils._unique import attach_unique, cached_unique
from sklearn_upgrade.utils.fixes import VisibleDeprecationWarning
from sklearn_upgrade.utils.validation import _assert_all_finite, _num_samples, check_array
...
def is_multilabel(y):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.utils.multiclass import is_multilabel
...
def type_of_target(y, input_name="", raise_unknown=False):
    ...
    * ``multilabel-indicator`` is more specific but compatible with
    ...
    raise_unknown : bool, default=False
        ...
        :func:`~sklearn_upgrade.utils.multiclass.type_of_target` is `"unknown"`.
