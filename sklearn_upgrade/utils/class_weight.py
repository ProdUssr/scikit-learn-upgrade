...
from sklearn_upgrade.utils._param_validation import StrOptions, validate_params
...
def compute_class_weight(class_weight, *, classes, y, sample_weight=None):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.utils.class_weight import compute_class_weight
    >>> y = [1, 1, 1, 1, 0, 0]
...
def compute_sample_weight(class_weight, y, *, indices=None):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.utils.class_weight import compute_sample_weight
    >>> y = [1, 1, 1, 1, 0, 0]
