...
from sklearn_upgrade.utils._repr_html.common import generate_link_to_param_doc
from sklearn_upgrade.utils._repr_html.params import ParamsDict, _params_html_repr, _read_params
...
def test_params_html_repr_with_doc_links():
    ...
    class MockEstimator:
        ...
        __module__ = "sklearn_upgrade.mock_module"
