...
from sklearn_upgrade.utils.validation import _is_arraylike_not_scalar
...
def validate_parameter_constraints(parameter_constraints, params, caller_name):
    ...
    for param_name, param_val in params.items():
        ...
        # can inherit from sklearn_upgrade estimators without having to necessarily use the
        # validation tools.
