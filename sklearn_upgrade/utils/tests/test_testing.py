...
from sklearn_upgrade.utils.deprecation import deprecated
...
def test_check_docstring_parameters():
    ...
    assert incorrect == [
        (
            "sklearn_upgrade.utils.tests.test_testing.f_check_param_definition There "
    ...
    messages = [
        [
            "In function: sklearn_upgrade.utils.tests.test_testing.f_bad_order",
            (
        ...
        [
            "In function: sklearn_upgrade.utils.tests.test_testing.f_too_many_param_docstring",
            (
        ...
        [
            "In function: sklearn_upgrade.utils.tests.test_testing.f_missing",
            (
        ...
        [
            "In function: sklearn_upgrade.utils.tests.test_testing.Klass.f_missing",
            (
                "Parameters in function docstring have less items w.r.t. function"
        ...
        [
            f"In function: sklearn_upgrade.utils.tests.test_testing.{mock_meta_name}.predict",
            (
                "There's a parameter name mismatch in function docstring w.r.t."
        ...
        [
            "In function: "
            f"sklearn_upgrade.utils.tests.test_testing.{mock_meta_name}."
            "predict_proba",
        ...
        [
            f"In function: sklearn_upgrade.utils.tests.test_testing.{mock_meta_name}.score",
            "potentially wrong underline length... ",
            "Parameters ",
            "--------- in ",
        ],
        [
            f"In function: sklearn_upgrade.utils.tests.test_testing.{mock_meta_name}.fit",
            (
                "Parameters in function docstring have less items w.r.t. function"
                " signature, first missing item: X"
            ),
...
def test_sklearn_upgrade_warnings_as_errors(warning_info):
    warnings_as_errors = os.environ.get("sklearn_upgrade_WARNINGS_AS_ERRORS", "0") != "0"
