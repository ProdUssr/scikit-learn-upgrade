...
from sklearn_upgrade.utils.fixes import _IS_32BIT, CSR_CONTAINERS, np_version, parse_version
...
class SimpleEstimatorCustomLogic(BaseEstimator):
    ...
    def __sklearn_upgrade_array_api_convert__(self, converter):
...
def test_get_namespace_and_device():
    ...
    from sklearn_upgrade.externals.array_api_compat import torch as torch_compat
...
def test_count_nonzero(
    ...
    from sklearn_upgrade.utils.sparsefuncs import count_nonzero as sparse_count_nonzero
