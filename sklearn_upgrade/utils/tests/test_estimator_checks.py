...
from sklearn_upgrade import config_context, get_config
from sklearn_upgrade.base import BaseEstimator, ClassifierMixin, OutlierMixin, TransformerMixin
from sklearn_upgrade.cluster import MiniBatchKMeans
...
from sklearn_upgrade.mixture import GaussianMixture
from sklearn_upgrade.neighbors import KNeighborsRegressor
from sklearn_upgrade.preprocessing import StandardScaler
from sklearn_upgrade.svm import SVC, NuSVC
from sklearn_upgrade.utils import _array_api, all_estimators, deprecated
...
from sklearn_upgrade.utils.estimator_checks import (
    _check_name,
    _NotAnArray,
    _yield_all_checks,
...
from sklearn_upgrade.utils.fixes import CSR_CONTAINERS, SPARRAY_PRESENT
...
class BadBalancedWeightsClassifier(BaseBadClassifier):
    ...
    def fit(self, X, y):
        ...
        from sklearn_upgrade.utils import compute_class_weight
...
def test_check_estimator_tags_renamed():
    ...
    # This shouldn't fail since we allow both __sklearn_upgrade_tags__ and _more_tags
    # to exist so that third party estimators can easily support multiple sklearn_upgrade
    # versions.
