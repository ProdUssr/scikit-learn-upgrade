...
from sklearn_upgrade.datasets import make_low_rank_matrix, make_sparse_spd_matrix
...
from sklearn_upgrade.utils.extmath import (
    _approximate_mode,
...
def test_approximate_mode():
    """Make sure sklearn_upgrade.utils.extmath._approximate_mode returns valid
