...
def _openmp_parallelism_enabled():
    ...
    """
    # sklearn_upgrade_OPENMP_PARALLELISM_ENABLED is resolved at compile time and defined
    # in _openmp_helpers.pxd as a boolean. This function exposes it to Python.
    return sklearn_upgrade_OPENMP_PARALLELISM_ENABLED
...
cpdef _openmp_effective_n_threads(n_threads=None, only_physical_cores=True):
    ...
    if not sklearn_upgrade_OPENMP_PARALLELISM_ENABLED:
