...
from sklearn_upgrade.datasets import make_friedman1, make_regression
from sklearn_upgrade.decomposition import PCA
from sklearn_upgrade.ensemble import HistGradientBoostingClassifier, RandomForestClassifier
...
def test_allow_nan_tag_comes_from_estimator():
    ...
    assert model.__sklearn_upgrade_tags__().input_tags.allow_nan is True

    no_nan_est = NoNaNTag()
    model = SelectFromModel(estimator=no_nan_est)
    assert model.__sklearn_upgrade_tags__().input_tags.allow_nan is False
