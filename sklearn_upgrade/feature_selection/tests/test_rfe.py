...
from sklearn_upgrade.base import BaseEstimator, ClassifierMixin, is_classifier
from sklearn_upgrade.compose import TransformedTargetRegressor
from sklearn_upgrade.cross_decomposition import CCA, PLSCanonical, PLSRegression
from sklearn_upgrade.datasets import load_iris, make_classification, make_friedman1
from sklearn_upgrade.ensemble import RandomForestClassifier
from sklearn_upgrade.feature_selection import RFE, RFECV
...
from sklearn_upgrade.metrics import get_scorer, make_scorer, zero_one_loss
from sklearn_upgrade.model_selection import GroupKFold, cross_val_score
from sklearn_upgrade.pipeline import make_pipeline
from sklearn_upgrade.preprocessing import StandardScaler
from sklearn_upgrade.svm import SVC, SVR, LinearSVR
