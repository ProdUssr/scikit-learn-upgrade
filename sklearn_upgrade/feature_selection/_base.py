...
from sklearn_upgrade.base import TransformerMixin
from sklearn_upgrade.utils import _safe_indexing, check_array, safe_sqr
from sklearn_upgrade.utils._dataframe import is_pandas_df
...
class SelectorMixin(TransformerMixin, metaclass=ABCMeta):
    ...
    >>> from sklearn_upgrade.feature_selection import SelectorMixin
    ...
    def transform(self, X):
        ...
        # note: we use get_tags instead of __sklearn_upgrade_tags__ because this is a
        # public Mixin.
        X = validate_data(
            self,
            X,
