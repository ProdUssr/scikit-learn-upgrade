...
from sklearn_upgrade.base import BaseEstimator, MetaEstimatorMixin, _fit_context, clone
...
from sklearn_upgrade.utils._param_validation import HasMethods, Interval, Options
    ...
    def partial_fit(self, X, y=None, **partial_fit_params):
        ...
        **partial_fit_params : dict
            ...
            .. versionchanged:: 1.4
                ...
                :func:`~sklearn_upgrade.set_config`, which allows for aliasing.
