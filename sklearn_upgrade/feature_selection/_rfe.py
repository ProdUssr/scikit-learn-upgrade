...
from sklearn_upgrade.feature_selection._base import SelectorMixin, _get_feature_importances
from sklearn_upgrade.metrics import get_scorer
from sklearn_upgrade.model_selection import check_cv
from sklearn_upgrade.model_selection._validation import _score
from sklearn_upgrade.utils import Bunch, metadata_routing
...
class RFE(SelectorMixin, MetaEstimatorMixin, BaseEstimator):
    ...
    importance_getter : str or callable, default='auto'
        ...
        :class:`~sklearn_upgrade.compose.TransformedTargetRegressor`  or
        `named_steps.clf.feature_importances_` in case of
        class:`~sklearn_upgrade.pipeline.Pipeline` with its last step named `clf`.
    ...
    >>> from sklearn_upgrade.feature_selection import RFE
...
class RFECV(RFE):
    ...
    cv : int, cross-validation generator or an iterable, default=None
        ...
        :class:`~sklearn_upgrade.model_selection.StratifiedKFold` is used. If the
    ...
    >>> from sklearn_upgrade.datasets import make_friedman1
    >>> from sklearn_upgrade.feature_selection import RFECV
    >>> from sklearn_upgrade.svm import SVR
    >>> X, y = make_friedman1(n_samples=50, n_features=10, random_state=0)
    >>> estimator = SVR(kernel="linear")
    ...
    :class:`~sklearn_upgrade.linear_model.LogisticRegression`, see
    :ref:`sphx_glr_auto_examples_feature_selection_plot_rfe_with_cross_validation.py`.
    """
