...
class SequentialFeatureSelector(SelectorMixin, MetaEstimatorMixin, BaseEstimator):
    ...
    cv : int, cross-validation generator or an iterable, default=None
        ...
        :class:`~sklearn_upgrade.model_selection.StratifiedKFold` is used. In all other
        cases, :class:`~sklearn_upgrade.model_selection.KFold` is used. These splitters
    ...
    Examples
    --------
    >>> from sklearn_upgrade.feature_selection import SequentialFeatureSelector
    ...
    def fit(self, X, y=None, **params):
        ...
        **params : dict, default=None
        ...
        tags = self.__sklearn_upgrade_tags__()
        X = validate_data(
            self,
            X,
            accept_sparse="csc",
