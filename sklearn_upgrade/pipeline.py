...
from sklearn_upgrade.base import TransformerMixin, _fit_context, clone
from sklearn_upgrade.exceptions import NotFittedError
from sklearn_upgrade.preprocessing import FunctionTransformer
from sklearn_upgrade.utils import Bunch
from sklearn_upgrade.utils._array_api import get_namespace, get_namespace_and_device
from sklearn_upgrade.utils._metadata_requests import METHODS
from sklearn_upgrade.utils._param_validation import HasMethods, Hidden
from sklearn_upgrade.utils._repr_html.estimator import _VisualBlock
from sklearn_upgrade.utils._set_output import _get_container_adapter, _safe_set_output
from sklearn_upgrade.utils._tags import get_tags
from sklearn_upgrade.utils._user_interface import _print_elapsed_time
...
from sklearn_upgrade.utils.metaestimators import _BaseComposition, available_if
from sklearn_upgrade.utils.parallel import Parallel, delayed
from sklearn_upgrade.utils.validation import check_is_fitted, check_memory
...
class Pipeline(_BaseComposition):
    ...
    :class:`~sklearn_upgrade.model_selection.GridSearchCV`, refer to
    ...
    transform_input : list of str, default=None
        ...
        can enable using ``sklearn_upgrade.set_config(enable_metadata_routing=True)``.
    ...
    Attributes
    ----------
    named_steps : :class:`~sklearn_upgrade.utils.Bunch`
    ...
    def fit(self, X, y=None, **params):
        ...
        **params : dict of str -> object
            ...
            .. versionchanged:: 1.4
                ...
                :func:`~sklearn_upgrade.set_config`.
    ...
    def __sklearn_upgrade_is_fitted__(self):
...
class FeatureUnion(TransformerMixin, _BaseComposition):
    ...
    Attributes
    ----------
    named_transformers : :class:`~sklearn_upgrade.utils.Bunch`
        Dictionary-like object, with the following attributes.
    ...
    Examples
    --------
    >>> from sklearn_upgrade.pipeline import FeatureUnion
    >>> from sklearn_upgrade.decomposition import PCA, TruncatedSVD
...
def make_union(
    ...
    *transformers : list of estimators
    ...
    --------
    >>> from sklearn_upgrade.decomposition import PCA, TruncatedSVD
    >>> from sklearn_upgrade.pipeline import make_union
