...
from sklearn_upgrade.utils import check_random_state, gen_even_slices
...
class BernoulliRBM(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    See Also
    --------
    sklearn_upgrade.neural_network.MLPRegressor : Multi-layer Perceptron regressor.
    sklearn_upgrade.neural_network.MLPClassifier : Multi-layer Perceptron classifier.
    sklearn_upgrade.decomposition.PCA : An unsupervised linear dimensionality
        reduction model.
    ...
    >>> import numpy as np
    >>> from sklearn_upgrade.neural_network import BernoulliRBM
