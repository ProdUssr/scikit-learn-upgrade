"""
Testing for Multi-layer Perceptron module (sklearn_upgrade.neural_network)
"""
...
from sklearn_upgrade.linear_model import PoissonRegressor
from sklearn_upgrade.metrics import roc_auc_score
from sklearn_upgrade.neural_network import MLPClassifier, MLPRegressor
from sklearn_upgrade.preprocessing import LabelBinarizer, MinMaxScaler, scale
