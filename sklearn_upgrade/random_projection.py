...
from sklearn_upgrade.exceptions import DataDimensionalityWarning
...
def johnson_lindenstrauss_min_dim(n_samples, *, eps=0.1):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.random_projection import johnson_lindenstrauss_min_dim
...
class GaussianRandomProjection(BaseRandomProjection):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.random_projection import GaussianRandomProjection
