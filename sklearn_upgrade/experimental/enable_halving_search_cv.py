...
:class:`~sklearn_upgrade.model_selection.HalvingRandomSearchCV` and
:class:`~sklearn_upgrade.model_selection.HalvingGridSearchCV` as attributes of the
...
from sklearn_upgrade import model_selection
