...
:class:`~sklearn_upgrade.ensemble.HistGradientBoostingRegressor` when they were still
:term:`experimental`, but these estimators are now stable and can be imported
normally from `sklearn_upgrade.ensemble`.
"""
...
warnings.warn(
    ...
    "stable and can be normally imported from sklearn_upgrade.ensemble."
)
