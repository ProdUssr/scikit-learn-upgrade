...
from sklearn_upgrade.base import BaseEstimator, ClassifierMixin, _fit_context
from sklearn_upgrade.exceptions import ConvergenceWarning, NotFittedError
from sklearn_upgrade.preprocessing import LabelEncoder
from sklearn_upgrade.svm import _liblinear as liblinear  # type: ignore[attr-defined]

# mypy error: error: Module 'sklearn_upgrade.svm' has no attribute '_libsvm'
# (and same for other imports)
from sklearn_upgrade.svm import _libsvm as libsvm  # type: ignore[attr-defined]
from sklearn_upgrade.svm import _libsvm_sparse as libsvm_sparse  # type: ignore[attr-defined]
...
from sklearn_upgrade.utils.fixes import SCIPY_VERSION_BELOW_1_12
