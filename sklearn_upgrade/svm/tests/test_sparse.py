...
from sklearn_upgrade import base, datasets, linear_model, svm
from sklearn_upgrade.datasets import load_digits, make_blobs, make_classification
from sklearn_upgrade.exceptions import ConvergenceWarning
from sklearn_upgrade.svm.tests import test_svm
