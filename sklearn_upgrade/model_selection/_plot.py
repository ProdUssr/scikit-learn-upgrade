...
from sklearn_upgrade.model_selection._validation import learning_curve, validation_curve
from sklearn_upgrade.utils._optional_dependencies import check_matplotlib_support
from sklearn_upgrade.utils._plotting import _interval_max_min_ratio, _validate_score_name
...
class LearningCurveDisplay(_BaseCurveDisplay):
    ...
    :meth:`~sklearn_upgrade.model_selection.LearningCurveDisplay.from_estimator` to
    create a :class:`~sklearn_upgrade.model_selection.LearningCurveDisplay` instance.
    ...
    See Also
    --------
    sklearn_upgrade.model_selection.learning_curve : Compute the learning curve.

    Examples
    --------
    >>> import matplotlib.pyplot as plt
    >>> from sklearn_upgrade.datasets import load_iris
    >>> from sklearn_upgrade.model_selection import LearningCurveDisplay, learning_curve
    ...
    def plot(
        ...
        *,
        ...
        negate_score : bool, default=False
            ...
            :func:`~sklearn_upgrade.model_selection.learning_curve`. This is
        ...
        Returns
        -------
        display : :class:`~sklearn_upgrade.model_selection.LearningCurveDisplay`
    ...
    def from_estimator(
        ...
        *,
        ...
        cv : int, cross-validation generator or an iterable, default=None
            ...
            :class:`~sklearn_upgrade.model_selection.StratifiedKFold` is used. In all
            other cases, :class:`~sklearn_upgrade.model_selection.KFold` is used. These
        ...
        >>> import matplotlib.pyplot as plt
        >>> from sklearn_upgrade.datasets import load_iris
        >>> from sklearn_upgrade.model_selection import LearningCurveDisplay
        >>> from sklearn_upgrade.tree import DecisionTreeClassifier
        >>> X, y = load_iris(return_X_y=True)
        >>> tree = DecisionTreeClassifier(random_state=0)
...
class ValidationCurveDisplay(_BaseCurveDisplay):
    ...
    It is recommended to use
    :meth:`~sklearn_upgrade.model_selection.ValidationCurveDisplay.from_estimator` to
    create a :class:`~sklearn_upgrade.model_selection.ValidationCurveDisplay` instance.
    All parameters are stored as attributes.
    ...
    See Also
    --------
    sklearn_upgrade.model_selection.validation_curve : Compute the validation curve.
    ...
    >>> from sklearn_upgrade.model_selection import ValidationCurveDisplay, validation_curve
    ...
    def plot(
        ...
        *,
        ...
        negate_score : bool, default=False
            Whether or not to negate the scores obtained through
            :func:`~sklearn_upgrade.model_selection.validation_curve`. This is
            particularly useful when using the error denoted by `neg_*` in
            `scikit-learn`.
        ...
        Returns
        -------
        display : :class:`~sklearn_upgrade.model_selection.ValidationCurveDisplay`
            Object that stores computed values.
        """
        self._plot_curve(
            self.param_range,
    ...
    def from_estimator(
        ...
        *,
        ...
        >>> import matplotlib.pyplot as plt
        >>> from sklearn_upgrade.datasets import make_classification
        >>> from sklearn_upgrade.model_selection import ValidationCurveDisplay
        >>> from sklearn_upgrade.linear_model import LogisticRegression
        >>> X, y = make_classification(n_samples=1_000, random_state=0)
        >>> logistic_regression = LogisticRegression()
        >>> param_name, param_range = "C", np.logspace(-8, 3, 10)
