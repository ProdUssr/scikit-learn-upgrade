...
from sklearn_upgrade.model_selection._validation import (
    _check_is_permutation,
    _fit_and_score,
    _score,
)
from sklearn_upgrade.model_selection.tests.common import OneTimeSplitter
from sklearn_upgrade.model_selection.tests.test_search import FailingClassifier
from sklearn_upgrade.multiclass import OneVsRestClassifier
from sklearn_upgrade.neighbors import KNeighborsClassifier
from sklearn_upgrade.neural_network import MLPRegressor
from sklearn_upgrade.pipeline import Pipeline
from sklearn_upgrade.preprocessing import LabelEncoder, scale
...
from sklearn_upgrade.utils import shuffle
...
from sklearn_upgrade.utils.estimator_checks import _NotAnArray
from sklearn_upgrade.utils.fixes import COO_CONTAINERS, CSR_CONTAINERS
