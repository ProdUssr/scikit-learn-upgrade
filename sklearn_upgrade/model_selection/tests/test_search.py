...
from sklearn_upgrade.base import BaseEstimator, ClassifierMixin, clone, is_classifier
from sklearn_upgrade.cluster import KMeans
from sklearn_upgrade.compose import ColumnTransformer
from sklearn_upgrade.datasets import (
    make_blobs,
    make_classification,
    make_multilabel_classification,
)
from sklearn_upgrade.discriminant_analysis import LinearDiscriminantAnalysis
from sklearn_upgrade.dummy import DummyClassifier
from sklearn_upgrade.ensemble import HistGradientBoostingClassifier
from sklearn_upgrade.exceptions import FitFailedWarning
from sklearn_upgrade.experimental import enable_halving_search_cv  # noqa: F401
from sklearn_upgrade.feature_extraction.text import TfidfVectorizer
from sklearn_upgrade.impute import SimpleImputer
from sklearn_upgrade.linear_model import (
    LinearRegression,
    LogisticRegression,
    Ridge,
    SGDClassifier,
)
from sklearn_upgrade.metrics import (
    accuracy_score,
    confusion_matrix,
    f1_score,
    make_scorer,
...
from sklearn_upgrade.model_selection import (
    GridSearchCV,
    GroupKFold,
    GroupShuffleSplit,
    HalvingGridSearchCV,
...
from sklearn_upgrade.model_selection._search import (
    BaseSearchCV,
    _yield_masked_array_for_each_param,
)
from sklearn_upgrade.model_selection.tests.common import OneTimeSplitter
from sklearn_upgrade.naive_bayes import ComplementNB
from sklearn_upgrade.neighbors import KernelDensity, KNeighborsClassifier, LocalOutlierFactor
from sklearn_upgrade.pipeline import Pipeline, make_pipeline
from sklearn_upgrade.preprocessing import (
    OneHotEncoder,
    OrdinalEncoder,
    SplineTransformer,
    StandardScaler,
)
from sklearn_upgrade.svm import SVC, LinearSVC
from sklearn_upgrade.tests.metadata_routing_common import (
    ConsumingScorer,
    _Registry,
    check_recorded_metadata,
)
from sklearn_upgrade.tree import DecisionTreeClassifier, DecisionTreeRegressor
from sklearn_upgrade.utils._array_api import (
    yield_namespace_device_dtype_combinations,
)
from sklearn_upgrade.utils._mocking import CheckingClassifier, MockDataFrame
...
from sklearn_upgrade.utils.estimator_checks import _enforce_estimator_tags_y
from sklearn_upgrade.utils.fixes import CSR_CONTAINERS
from sklearn_upgrade.utils.validation import _num_samples
...
def test_grid_search():
    ...
    grid_search.scoring = "sklearn_upgrade"
...
@pytest.mark.filterwarnings("ignore::sklearn_upgrade.exceptions.UndefinedMetricWarning")
def test_refit():
...
@pytest.mark.filterwarnings("ignore::sklearn_upgrade.exceptions.FitFailedWarning")
...
def test_search_cv_pairwise_property_delegated_to_base_estimator(pairwise):
    ...
    assert pairwise == cv.__sklearn_upgrade_tags__().input_tags.pairwise, attr_message
...
def test_search_cv__pairwise_property_delegated_to_base_estimator():
    ...
    for _pairwise_setting in [True, False]:
        ...
        cv = GridSearchCV(est, {"n_neighbors": [10]})
        assert _pairwise_setting == cv.__sklearn_upgrade_tags__().input_tags.pairwise, (
            attr_message
        )
