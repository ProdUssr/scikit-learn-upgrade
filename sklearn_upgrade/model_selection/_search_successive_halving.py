...
from sklearn_upgrade.base import _fit_context, is_classifier
from sklearn_upgrade.metrics._scorer import get_scorer_names
from sklearn_upgrade.model_selection import ParameterGrid, ParameterSampler
from sklearn_upgrade.model_selection._search import BaseSearchCV
from sklearn_upgrade.model_selection._split import _yields_constant_splits, check_cv
from sklearn_upgrade.utils import resample
...
class HalvingGridSearchCV(BaseSuccessiveHalving):
    ...
    .. note::
      ...
      you need to explicitly import ``enable_halving_search_cv``::
        ...
        >>> from sklearn_upgrade.experimental import enable_halving_search_cv # noqa
