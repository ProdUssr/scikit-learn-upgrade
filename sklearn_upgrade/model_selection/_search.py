"""
The :mod:`sklearn_upgrade.model_selection._search` includes utilities to fine-tune the
...
from sklearn_upgrade.metrics._scorer import (
...
from sklearn_upgrade.utils import Bunch, check_random_state
from sklearn_upgrade.utils._array_api import xpx
from sklearn_upgrade.utils._param_validation import HasMethods, Interval, StrOptions
...
from sklearn_upgrade.utils.validation import _check_method_params, check_is_fitted, indexable
...
class ParameterGrid:
    ...
    Examples
    --------
    >>> from sklearn_upgrade.model_selection import ParameterGrid
...
class ParameterSampler:
    ...
    Examples
    --------
    >>> from sklearn_upgrade.model_selection import ParameterSampler
...
class GridSearchCV(BaseSearchCV):
    ...
    Examples
    --------
    >>> from sklearn_upgrade import svm, datasets
