...
from sklearn_upgrade.base import ClassifierMixin, clone
...
from sklearn_upgrade.metrics import jaccard_score, mean_squared_error
from sklearn_upgrade.model_selection import GridSearchCV, train_test_split
