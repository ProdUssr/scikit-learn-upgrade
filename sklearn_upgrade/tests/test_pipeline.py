...
from sklearn_upgrade.dummy import DummyRegressor
from sklearn_upgrade.ensemble import (
    HistGradientBoostingClassifier,
    RandomForestClassifier,
    RandomTreesEmbedding,
)
from sklearn_upgrade.exceptions import NotFittedError, UnsetMetadataPassedError
from sklearn_upgrade.feature_extraction.text import CountVectorizer
from sklearn_upgrade.feature_selection import SelectKBest, f_classif
from sklearn_upgrade.impute import SimpleImputer
from sklearn_upgrade.kernel_approximation import Nystroem
from sklearn_upgrade.linear_model import Lasso, LinearRegression, LogisticRegression
from sklearn_upgrade.metrics import accuracy_score, r2_score
from sklearn_upgrade.model_selection import train_test_split
from sklearn_upgrade.neighbors import LocalOutlierFactor
from sklearn_upgrade.pipeline import FeatureUnion, Pipeline, make_pipeline, make_union
from sklearn_upgrade.preprocessing import FunctionTransformer, StandardScaler
...
from sklearn_upgrade.utils import get_tags
...
from sklearn_upgrade.utils._metadata_requests import COMPOSITE_METHODS, METHODS
...
from sklearn_upgrade.utils.validation import _check_feature_names, check_is_fitted
...
def test_sklearn_upgrade_tags_with_empty_pipeline():
    ...
    expected_tags = be.__sklearn_upgrade_tags__()
    assert empty_pipeline.__sklearn_upgrade_tags__() == expected_tags
...
def test_pipeline_get_tags_none(passthrough):
    ...
    assert not pipe.__sklearn_upgrade_tags__().input_tags.pairwise
...
def test_feature_union_check_if_fitted():
    """Check __sklearn_upgrade_is_fitted__ is defined correctly."""
...
def test_pipeline_warns_not_fitted(method):
    class StatelessEstimator(BaseEstimator):
        ...
        `requires_fit` flag and implement a `__sklearn_upgrade_check_is_fitted__` returning
        `True`.
        """
