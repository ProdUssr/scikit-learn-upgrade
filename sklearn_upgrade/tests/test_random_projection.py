...
from sklearn_upgrade.exceptions import DataDimensionalityWarning, NotFittedError
from sklearn_upgrade.metrics import euclidean_distances
from sklearn_upgrade.random_projection import (
...
from sklearn_upgrade.utils.fixes import COO_CONTAINERS
