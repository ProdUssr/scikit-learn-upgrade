...
from sklearn_upgrade._min_dependencies import dependent_packages
...
def test_min_dependencies_readme():
    ...
    # sklearn_upgrade/_min_dependencies.py
    ...
    readme_path = Path(sklearn_upgrade.__file__).parent.parent
...
def test_min_dependencies_pyproject_toml():
    ...
    root_directory = Path(sklearn_upgrade.__file__).parent.parent
