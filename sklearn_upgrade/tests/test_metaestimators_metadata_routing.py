...
from sklearn_upgrade.base import BaseEstimator, is_classifier
...
from sklearn_upgrade.metrics._regression import mean_squared_error
from sklearn_upgrade.metrics._scorer import make_scorer
...
from sklearn_upgrade.semi_supervised import SelfTrainingClassifier
...
from sklearn_upgrade.utils.metadata_routing import MetadataRouter
