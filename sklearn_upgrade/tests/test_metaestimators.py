...
from sklearn_upgrade.base import BaseEstimator, clone, is_regressor
...
from sklearn_upgrade.linear_model import LogisticRegression, Ridge
from sklearn_upgrade.model_selection import GridSearchCV, RandomizedSearchCV
from sklearn_upgrade.pipeline import Pipeline, make_pipeline
from sklearn_upgrade.preprocessing import MaxAbsScaler, StandardScaler
...
from sklearn_upgrade.utils._testing import SkipTest, set_random_state
