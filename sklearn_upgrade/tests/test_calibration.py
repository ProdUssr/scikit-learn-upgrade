...
from sklearn_upgrade.base import BaseEstimator, ClassifierMixin, clone
from sklearn_upgrade.calibration import (
...
from sklearn_upgrade.datasets import load_iris, make_blobs, make_classification
...
from sklearn_upgrade.feature_extraction import DictVectorizer
...
from sklearn_upgrade.linear_model import LogisticRegression, SGDClassifier
...
from sklearn_upgrade.naive_bayes import MultinomialNB
...
from sklearn_upgrade.utils._mocking import CheckingClassifier
...
@pytest.mark.filterwarnings("ignore::sklearn_upgrade.exceptions.ConvergenceWarning")
