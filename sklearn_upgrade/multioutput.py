...
from sklearn_upgrade.utils import Bunch, check_random_state, get_tags
...
class MultiOutputRegressor(RegressorMixin, _MultiOutputEstimator):
    ...
    >>> from sklearn_upgrade.multioutput import MultiOutputRegressor
...
class ClassifierChain(MetaEstimatorMixin, ClassifierMixin, _BaseChain):
    ...
    >>> from sklearn_upgrade.multioutput import ClassifierChain
...
class RegressorChain(MetaEstimatorMixin, RegressorMixin, _BaseChain):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.multioutput import RegressorChain
    >>> from sklearn_upgrade.linear_model import LogisticRegression
