...
from sklearn_upgrade.base import BaseEstimator, TransformerMixin, _fit_context
from sklearn_upgrade.utils._mask import _get_mask
from sklearn_upgrade.utils._missing import is_pandas_na, is_scalar_nan
from sklearn_upgrade.utils._param_validation import MissingValues, StrOptions
from sklearn_upgrade.utils._sparse import _align_api_if_sparse
from sklearn_upgrade.utils.fixes import SCIPY_VERSION_BELOW_1_12, _mode
from sklearn_upgrade.utils.sparsefuncs import _get_median
...
class SimpleImputer(_BaseImputer):
    ...
    .. versionadded:: 0.20
       `SimpleImputer` replaces the previous `sklearn_upgrade.preprocessing.Imputer`
    ...
    :class:`~sklearn_upgrade.impute.IterativeImputer` or :class:`~sklearn_upgrade.impute.KNNImputer`.
...
class MissingIndicator(TransformerMixin, BaseEstimator):
    ...
    :class:`~sklearn_upgrade.pipeline.Pipeline` consisting of transformers and a
    classifier, but rather could be added using a
    :class:`~sklearn_upgrade.pipeline.FeatureUnion` or
    :class:`~sklearn_upgrade.compose.ColumnTransformer`.
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.impute import MissingIndicator
