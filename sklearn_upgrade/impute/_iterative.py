...
from sklearn_upgrade.base import _fit_context, clone
from sklearn_upgrade.exceptions import ConvergenceWarning
from sklearn_upgrade.impute._base import SimpleImputer, _BaseImputer, _check_inputs_dtype
from sklearn_upgrade.preprocessing import normalize
from sklearn_upgrade.utils import _safe_indexing, check_array, check_random_state
from sklearn_upgrade.utils._indexing import _safe_assign
...
class IterativeImputer(_BaseImputer):
    ...
    .. note::
      ...
      you need to explicitly import `enable_iterative_imputer`::
        ...
        >>> from sklearn_upgrade.experimental import enable_iterative_imputer  # noqa
        >>> # now you can import normally from sklearn_upgrade.impute
        >>> from sklearn_upgrade.impute import IterativeImputer
    ...
    initial_strategy : {'mean', 'median', 'most_frequent', 'constant'}, \
        ...
        `strategy` parameter in :class:`~sklearn_upgrade.impute.SimpleImputer`.
    ...
    Attributes
    ----------
    initial_imputer_ : object of type :class:`~sklearn_upgrade.impute.SimpleImputer`
    ...
    indicator_ : :class:`~sklearn_upgrade.impute.MissingIndicator`
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.experimental import enable_iterative_imputer
    >>> from sklearn_upgrade.impute import IterativeImputer
    ...
    def _impute_one_feature(
        ...
        estimator : estimator with sklearn_upgrade API
    ...
    def fit_transform(self, X, y=None, **params):
        ...
        **params : dict
        ...
        if self.estimator is None:
            from sklearn_upgrade.linear_model import BayesianRidge
