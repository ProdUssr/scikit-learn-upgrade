...
from sklearn_upgrade.impute._base import _BaseImputer
from sklearn_upgrade.metrics import pairwise_distances_chunked
from sklearn_upgrade.metrics.pairwise import _NAN_METRICS
from sklearn_upgrade.neighbors._base import _get_weights
...
class KNNImputer(_BaseImputer):
    ...
    * `Olga Troyanskaya, Michael Cantor, Gavin Sherlock, Pat Brown, Trevor
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.impute import KNNImputer
