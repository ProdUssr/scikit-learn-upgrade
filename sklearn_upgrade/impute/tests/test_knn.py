...
from sklearn_upgrade.metrics.pairwise import nan_euclidean_distances, pairwise_distances
...
def test_knn_tags(na, allow_nan):
    ...
    assert knn.__sklearn_upgrade_tags__().input_tags.allow_nan == allow_nan
