...
from sklearn_upgrade.base import OneToOneFeatureMixin, _fit_context
from sklearn_upgrade.preprocessing._encoders import _BaseEncoder
from sklearn_upgrade.preprocessing._target_encoder_fast import (
    _fit_encoding_fast,
    _fit_encoding_fast_auto_smooth,
)
from sklearn_upgrade.utils import Bunch, indexable
...
class TargetEncoder(OneToOneFeatureMixin, _BaseEncoder):
    ...
    :class:`~sklearn_upgrade.preprocessing.LabelBinarizer`, then the average target
    ...
    target_type : {"auto", "continuous", "binary", "multiclass"}, default="auto"
        ...
        - `"auto"` : Type of target is inferred with
          :func:`~sklearn_upgrade.utils.multiclass.type_of_target`.
        ...
        .. note::
            ...
            between 0 and 100, then :func:`~sklearn_upgrade.utils.multiclass.type_of_target`
    ...
    >>> import numpy as np
    >>> from sklearn_upgrade.preprocessing import TargetEncoder
