...
from sklearn_upgrade.utils import _align_api_if_sparse, column_or_1d
...
from sklearn_upgrade.utils._param_validation import Interval, validate_params
from sklearn_upgrade.utils.multiclass import type_of_target, unique_labels
from sklearn_upgrade.utils.sparsefuncs import min_max_axis
from sklearn_upgrade.utils.validation import _num_samples, check_array, check_is_fitted
...
class LabelBinarizer(TransformerMixin, BaseEstimator, auto_wrap_output_keys=None):
    ...
    y_type_ : str
        ...
        :func:`~sklearn_upgrade.utils.multiclass.type_of_target`. Possible type are
