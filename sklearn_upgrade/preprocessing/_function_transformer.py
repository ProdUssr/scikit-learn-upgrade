...
from sklearn_upgrade.utils._set_output import _get_adapter_from_container, _get_output_config
...
class FunctionTransformer(TransformerMixin, BaseEstimator):
    ...
    def set_output(self, *, transform=None):
        ...
        self : estimator instance
            Estimator instance.
        """
        if not hasattr(self, "_sklearn_upgrade_output_config"):
            self._sklearn_upgrade_output_config = {}

        self._sklearn_upgrade_output_config["transform"] = transform
        return self
