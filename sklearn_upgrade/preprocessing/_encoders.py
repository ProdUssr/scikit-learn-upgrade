...
from sklearn_upgrade.utils import _align_api_if_sparse, _safe_indexing, check_array
from sklearn_upgrade.utils._encode import _check_unknown, _encode, _get_counts, _unique
...
from sklearn_upgrade.utils.fixes import _ensure_sparse_index_int32
...
class OneHotEncoder(_BaseEncoder):
    ...
    sklearn_upgrade.feature_extraction.DictVectorizer : Performs a one-hot encoding of
      dictionary items (also handles string-valued features).
    sklearn_upgrade.feature_extraction.FeatureHasher : Performs an approximate one-hot
    ...
    def _compute_transformed_categories(self, i, remove_dropped=True):
        ...
        if self._infrequent_enabled:
            ...
            if infreq_map is not None:
                ...
                infrequent_cat = "infrequent_sklearn_upgrade"
    ...
    def inverse_transform(self, X):
        ...
        'infrequent_sklearn_upgrade' will be used to represent the infrequent category.
    ...
    def inverse_transform(self, X):
        ...
        for i in range(n_features):
            ...
            if infrequent_indices is not None and infrequent_indices[i] is not None:
                ...
                # categories will be mapped to "infrequent_sklearn_upgrade" later
        ...
        if infrequent_masks:
            for idx, mask in infrequent_masks.items():
                X_tr[mask, idx] = "infrequent_sklearn_upgrade"
