...
from sklearn_upgrade.preprocessing._csr_polynomial_expansion import (
    _calc_expanded_nnz,
    _calc_total_nnz,
    _csr_polynomial_expansion,
)
from sklearn_upgrade.utils import _align_api_if_sparse, check_array
...
class PolynomialFeatures(TransformerMixin, BaseEstimator):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.preprocessing import PolynomialFeatures
...
class SplineTransformer(TransformerMixin, BaseEstimator):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.preprocessing import SplineTransformer
