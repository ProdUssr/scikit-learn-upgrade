...
from sklearn_upgrade.preprocessing import MultiLabelBinarizer
from sklearn_upgrade.utils import Bunch, check_array, check_random_state
from sklearn_upgrade.utils import shuffle as util_shuffle
...
def make_classification(
    ...
    *,
    ...
    Returns
    -------
    data : :class:`~sklearn_upgrade.utils.Bunch` if `return_X_y` is `False`.
...
def make_circles(
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import make_circles
...
def make_moons(n_samples=100, *, shuffle=True, noise=None, random_state=None):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import make_moons
...
def make_blobs(
    ...
    *,
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import make_blobs
...
def make_friedman2(n_samples=100, *, noise=0.0, random_state=None):
 ...
 - 1 / (X[:, 1] * X[:, 3])) ** 2) ** 0.5 + noise * N(0, 1).
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import make_friedman2
...
/ X[:, 0]) + noise * N(0, 1).
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import make_friedman3
...
def make_low_rank_matrix(
    ...
    *,
    ...
    >>> from sklearn_upgrade.datasets import make_low_rank_matrix
    >>> X = make_low_rank_matrix(
    ...     n_samples=50,
    ...     n_features=25,
    ...     effective_rank=5,
...
def make_sparse_coded_signal(
    ...
    *,
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import make_sparse_coded_signal
...
def make_sparse_uncorrelated(n_samples=100, n_features=10, *, random_state=None):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import make_sparse_uncorrelated
...
def make_spd_matrix(n_dim, *, random_state=None):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import make_spd_matrix
...
def make_sparse_spd_matrix(
    ...
    *,
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import make_sparse_spd_matrix
...
def make_swiss_roll(n_samples=100, *, noise=0.0, random_state=None, hole=False):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import make_swiss_roll
...
def make_s_curve(n_samples=100, *, noise=0.0, random_state=None):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import make_s_curve
...
def make_gaussian_quantiles(
    *,
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import make_gaussian_quantiles
...
def make_biclusters(
    ...
    *,
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import make_biclusters
...
def make_checkerboard(
    ...
    *,
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import make_checkerboard
