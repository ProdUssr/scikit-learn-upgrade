...
from sklearn_upgrade.utils._optional_dependencies import check_pandas_support
from sklearn_upgrade.utils._param_validation import Interval, StrOptions, validate_params

DATA_MODULE = "sklearn_upgrade.datasets.data"
DESCR_MODULE = "sklearn_upgrade.datasets.descr"
IMAGES_MODULE = "sklearn_upgrade.datasets.images"
...
def get_data_home(data_home=None) -> str:
    ...
    --------
    >>> import os
    >>> from sklearn_upgrade.datasets import get_data_home
...
def clear_data_home(data_home=None):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import clear_data_home
...
def load_files(
    ...
    *,
    ...
    you will need to use the :mod:`~sklearn_upgrade.feature_extraction.text` module to
    ...
    to use most functions in :mod:`~sklearn_upgrade.feature_extraction.text`.
    ...
    Returns
    -------
    data : :class:`~sklearn_upgrade.utils.Bunch`
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import load_files
    >>> container_path = "./"
...
def load_csv_data(
    ...
    *,
    ...
    data_module : str or module, default='sklearn_upgrade.datasets.data'
        Module where data lives. The default is `'sklearn_upgrade.datasets.data'`.
    ...
    descr_module : str or module, default='sklearn_upgrade.datasets.descr'
        Module where `descr_file_name` lives. See also :func:`load_descr`.
        The default is `'sklearn_upgrade.datasets.descr'`.
...
def load_wine(*, return_X_y=False, as_frame=False):
    ...
    >>> from sklearn_upgrade.datasets import load_wine
    >>> data = load_wine()
...
def load_linnerud(*, return_X_y=False, as_frame=False):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import load_linnerud
...
def load_sample_images():
    ...
    >>> from sklearn_upgrade.datasets import load_sample_images
...
def load_sample_image(image_name):
    ...
    >>> from sklearn_upgrade.datasets import load_sample_image
