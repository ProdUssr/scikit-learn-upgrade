...
from sklearn_upgrade.datasets._svmlight_format_io import load_svmlight_files
from sklearn_upgrade.utils import Bunch
from sklearn_upgrade.utils import shuffle as shuffle_
...
def fetch_rcv1(
    *,
    ...
    Returns
    -------
    dataset : :class:`~sklearn_upgrade.utils.Bunch`
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import fetch_rcv1
    >>> rcv1 = fetch_rcv1()
    >>> rcv1.data.shape
    (804414, 47236)
    >>> rcv1.target.shape
