...
from sklearn_upgrade.datasets._svmlight_format_fast import (
    _dump_svmlight_file,
    _load_svmlight_file,
)
...
def load_svmlight_file(
    ...
    *,
    ...
    To use joblib.Memory to cache the svmlight file::
        ...
        from sklearn_upgrade.datasets import load_svmlight_file
        mem = Memory("./mycache")
...
def dump_svmlight_file(
    ...
    *,
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import dump_svmlight_file, make_classification
