...
from sklearn_upgrade.datasets._base import RemoteFileMetadata, _fetch_remote, _pkl_filepath
...
def fetch_species_distributions(
    ...
    * `"Maximum entropy modeling of species geographic distributions"
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import fetch_species_distributions
