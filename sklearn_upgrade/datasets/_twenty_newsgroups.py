...
from sklearn_upgrade import preprocessing
from sklearn_upgrade.datasets import get_data_home, load_files
from sklearn_upgrade.datasets._base import (
    RemoteFileMetadata,
...
from sklearn_upgrade.utils.fixes import tarfile_extractall
...
(classification).
    ...
    Returns
    -------
    bunch : :class:`~sklearn_upgrade.utils.Bunch`
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import fetch_20newsgroups
...
def fetch_20newsgroups_vectorized(
    *,
    ...
    :class:`~sklearn_upgrade.feature_extraction.text.CountVectorizer`. For more
    advanced usage (stopword filtering, n-gram extraction, etc.), combine
    fetch_20newsgroups with a custom
    :class:`~sklearn_upgrade.feature_extraction.text.CountVectorizer`,
    :class:`~sklearn_upgrade.feature_extraction.text.HashingVectorizer`,
    :class:`~sklearn_upgrade.feature_extraction.text.TfidfTransformer` or
    :class:`~sklearn_upgrade.feature_extraction.text.TfidfVectorizer`.

    The resulting counts are normalized using
    :func:`sklearn_upgrade.preprocessing.normalize` unless normalize is set to False.
    ...
    normalize : bool, default=True
        ...
        :func:`sklearn_upgrade.preprocessing.normalize`.
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import fetch_20newsgroups_vectorized
