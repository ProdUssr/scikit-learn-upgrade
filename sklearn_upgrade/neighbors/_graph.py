...
from sklearn_upgrade.base import ClassNamePrefixFeaturesOutMixin, TransformerMixin, _fit_context
...
def kneighbors_graph(
    ...
    *,
    ...
    metric : str, default='minkowski'
        ...
        :class:`~sklearn_upgrade.metrics.pairwise.distance_metrics` for valid metric
        values.
...
def radius_neighbors_graph(
    ...
    *,
    ...
    --------
    >>> X = [[0], [3], [1]]
    >>> from sklearn_upgrade.neighbors import radius_neighbors_graph
...
class KNeighborsTransformer(
    ...
    Notes
    -----
    For an example of using :class:`~sklearn_upgrade.neighbors.KNeighborsTransformer`
    in combination with :class:`~sklearn_upgrade.manifold.TSNE` see
    :ref:`sphx_glr_auto_examples_neighbors_approximate_nearest_neighbors.py`.

    Examples
    --------
    >>> from sklearn_upgrade.datasets import load_wine
    >>> from sklearn_upgrade.neighbors import KNeighborsTransformer
...
class RadiusNeighborsTransformer(
    ...
    >>> from sklearn_upgrade.neighbors import RadiusNeighborsTransformer
