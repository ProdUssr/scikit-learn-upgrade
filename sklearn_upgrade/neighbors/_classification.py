...
from sklearn_upgrade.base import ClassifierMixin, _fit_context
from sklearn_upgrade.metrics._pairwise_distances_reduction import (
    ArgKminClassMode,
...
from sklearn_upgrade.utils.arrayfuncs import _all_with_any_reduction_axis_1
from sklearn_upgrade.utils.extmath import weighted_mode
from sklearn_upgrade.utils.fixes import _mode
...
class RadiusNeighborsClassifier(RadiusNeighborsMixin, ClassifierMixin, NeighborsBase):
    ...
    >>> X = [[0], [1], [2], [3]]
    >>> y = [0, 0, 1, 1]
    >>> from sklearn_upgrade.neighbors import RadiusNeighborsClassifier
