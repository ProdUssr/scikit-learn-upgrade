...
from sklearn_upgrade.neighbors._base import VALID_METRICS
...
class KernelDensity(BaseEstimator):
    ...
    See Also
    --------
    sklearn_upgrade.neighbors.KDTree : K-dimensional tree for fast generalized N-point
        problems.
    sklearn_upgrade.neighbors.BallTree : Ball tree for fast generalized N-point
        problems.
    ...
    >>> from sklearn_upgrade.neighbors import KernelDensity
    >>> import numpy as np
