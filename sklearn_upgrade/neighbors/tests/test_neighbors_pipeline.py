...
from sklearn_upgrade.cluster import DBSCAN, SpectralClustering
from sklearn_upgrade.cluster.tests.common import generate_clustered_data
from sklearn_upgrade.datasets import make_blobs
from sklearn_upgrade.manifold import TSNE, Isomap, SpectralEmbedding
...
from sklearn_upgrade.utils._testing import assert_array_almost_equal
