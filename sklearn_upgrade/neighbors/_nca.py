...
from sklearn_upgrade.utils.random import check_random_state
from sklearn_upgrade.utils.validation import check_array, check_is_fitted, validate_data
...
class NeighborhoodComponentsAnalysis(
    ...
    init : {'auto', 'pca', 'lda', 'identity', 'random'} or ndarray of shape \
        ...
        - `'pca'`
            ...
            (See :class:`~sklearn_upgrade.decomposition.PCA`)
    ...
    See Also
    --------
    sklearn_upgrade.discriminant_analysis.LinearDiscriminantAnalysis : Linear
        Discriminant Analysis.
    sklearn_upgrade.decomposition.PCA : Principal component analysis (PCA).
    ...
    Examples
    --------
    >>> from sklearn_upgrade.neighbors import NeighborhoodComponentsAnalysis
