...
from sklearn_upgrade.neighbors._base import KNeighborsMixin, NeighborsBase
...
class LocalOutlierFactor(KNeighborsMixin, OutlierMixin, NeighborsBase):
    ...
    p : float, default=2
        ...
        :func:`sklearn_upgrade.metrics.pairwise_distances`. When p = 1, this
    ...
    See Also
    --------
    sklearn_upgrade.svm.OneClassSVM: Unsupervised Outlier Detection using
