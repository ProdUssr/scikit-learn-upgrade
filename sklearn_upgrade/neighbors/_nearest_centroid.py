...
from sklearn_upgrade.discriminant_analysis import DiscriminantAnalysisPredictionMixin
from sklearn_upgrade.metrics.pairwise import pairwise_distances, pairwise_distances_argmin
from sklearn_upgrade.preprocessing import LabelEncoder
from sklearn_upgrade.utils import get_tags
from sklearn_upgrade.utils._available_if import available_if
...
from sklearn_upgrade.utils.sparsefuncs import csc_median_axis_0
...
class NearestCentroid(
    ...
    Examples
    --------
    >>> from sklearn_upgrade.neighbors import NearestCentroid
    >>> import numpy as np
