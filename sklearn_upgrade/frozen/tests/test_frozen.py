...
from sklearn_upgrade.preprocessing import RobustScaler, StandardScaler
from sklearn_upgrade.utils._testing import set_random_state
...
def test_frozen_tags():
    ...
    estimator = Estimator()
    frozen = FrozenEstimator(estimator)
    frozen_tags = frozen.__sklearn_upgrade_tags__()
    estimator_tags = estimator.__sklearn_upgrade_tags__()
