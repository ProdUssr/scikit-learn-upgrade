...
class NotFittedError(ValueError, AttributeError):
    ...
    .. versionchanged:: 0.18
       Moved from sklearn_upgrade.utils.validation.
    """
...
class ConvergenceWarning(UserWarning):
    ...
    .. versionchanged:: 0.18
       Moved from sklearn_upgrade.utils.
    """
...
class FitFailedWarning(RuntimeWarning):
    ...
    .. versionchanged:: 0.18
       Moved from sklearn_upgrade.cross_validation.
    """
...
class UndefinedMetricWarning(UserWarning):
    ...
    .. versionchanged:: 0.18
       Moved from sklearn_upgrade.base.
    """
...
class InconsistentVersionWarning(UserWarning):
    ...
    current_sklearn_upgrade_version : str
        Current scikit-learn version.

    original_sklearn_upgrade_version : str
        Original scikit-learn version.
    """

    def __init__(
        self, *, estimator_name, current_sklearn_upgrade_version, original_sklearn_upgrade_version
    ):
        self.estimator_name = estimator_name
        self.current_sklearn_upgrade_version = current_sklearn_upgrade_version
        self.original_sklearn_upgrade_version = original_sklearn_upgrade_version

    def __str__(self):
        return (
            f"Trying to unpickle estimator {self.estimator_name} from version"
            f" {self.original_sklearn_upgrade_version} when "
            f"using version {self.current_sklearn_upgrade_version}. This might lead to breaking"
            " code or "
