...
from sklearn_upgrade._loss import (
    HalfBinomialLoss,
    HalfMultinomialLoss,
...
from sklearn_upgrade.externals import array_api_extra as xpx
from sklearn_upgrade.frozen import FrozenEstimator
from sklearn_upgrade.isotonic import IsotonicRegression
from sklearn_upgrade.model_selection import LeaveOneOut, check_cv, cross_val_predict
from sklearn_upgrade.preprocessing import LabelEncoder, label_binarize
from sklearn_upgrade.svm import LinearSVC
from sklearn_upgrade.utils import Bunch, _safe_indexing, column_or_1d, get_tags, indexable
...
from sklearn_upgrade.utils._plotting import (
    _BinaryClassifierCurveDisplayMixin,
    _validate_style_kwargs,
)
from sklearn_upgrade.utils._response import _get_response_values, _process_predict_proba
from sklearn_upgrade.utils.extmath import softmax
from sklearn_upgrade.utils.metadata_routing import (
    MetadataRouter,
    MethodMapping,
    _routing_enabled,
    process_routing,
)
from sklearn_upgrade.utils.multiclass import check_classification_targets
...
class CalibratedClassifierCV(ClassifierMixin, MetaEstimatorMixin, BaseEstimator):
    ...
    via :func:`~sklearn_upgrade.model_selection.cross_val_predict`, which are then
    used for calibration. For prediction, the base estimator, trained using all
    the data, is used. This is the prediction method implemented when
    `probabilities=True` for :class:`~sklearn_upgrade.svm.SVC` and :class:`~sklearn_upgrade.svm.NuSVC`
    ...
    :class:`~sklearn_upgrade.frozen.FrozenEstimator`. In this case all provided
    ...
    estimator : estimator instance, default=None
        ...
        a :class:`~sklearn_upgrade.svm.LinearSVC`.
    ...
    cv : int, cross-validation generator, or iterable, default=None
        ...
        :class:`~sklearn_upgrade.model_selection.StratifiedKFold` is used. If ``y`` is
        neither binary nor multiclass, :class:`~sklearn_upgrade.model_selection.KFold`
        is used.
    ...
    ensemble : bool, or "auto", default="auto"
        ...
        :class:`~sklearn_upgrade.frozen.FrozenEstimator`, and `True` otherwise.
        ...
        :func:`~sklearn_upgrade.model_selection.cross_val_predict`, which are then
        used for calibration. At prediction time, the classifier used is the
        `estimator` trained on all the data.
        Note that this method is also internally implemented  in
        :mod:`sklearn_upgrade.svm` estimators with the `probabilities=True` parameter.
    ...
    >>> from sklearn_upgrade.naive_bayes import GaussianNB
    >>> from sklearn_upgrade.calibration import CalibratedClassifierCV
    ...
    def get_metadata_routing(self):
        ...
        routing : MetadataRouter
            A :class:`~sklearn_upgrade.utils.metadata_routing.MetadataRouter` encapsulating
            routing information.
        """
        router = (
...
def calibration_curve(
    ...
    *,
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.calibration import calibration_curve
...
class CalibrationDisplay(_BinaryClassifierCurveDisplayMixin):
    ...
    :func:`~sklearn_upgrade.calibration.CalibrationDisplay.from_estimator` or
    :func:`~sklearn_upgrade.calibration.CalibrationDisplay.from_predictions`
    ...
    >>> from sklearn_upgrade.calibration import calibration_curve, CalibrationDisplay
    ...
    def plot(self, *, ax=None, name=None, ref_line=True, **kwargs):
        ...
        **kwargs : dict
        ...
        Returns
        -------
        display : :class:`~sklearn_upgrade.calibration.CalibrationDisplay`
    ...
    def from_estimator(
        ...
        **kwargs,
        ...
        ----------
        estimator : estimator instance
            Fitted classifier or a fitted :class:`~sklearn_upgrade.pipeline.Pipeline`
        ...
        **kwargs : dict
        ...
        >>> from sklearn_upgrade.model_selection import train_test_split
        >>> from sklearn_upgrade.linear_model import LogisticRegression
        >>> from sklearn_upgrade.calibration import CalibrationDisplay
        >>> X, y = make_classification(random_state=0)
        >>> X_train, X_test, y_train, y_test = train_test_split(
        ...     X, y, random_state=0)
        >>> clf = LogisticRegression(random_state=0)
