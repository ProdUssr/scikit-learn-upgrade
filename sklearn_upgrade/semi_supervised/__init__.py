...
from sklearn_upgrade.semi_supervised._label_propagation import LabelPropagation, LabelSpreading
from sklearn_upgrade.semi_supervised._self_training import SelfTrainingClassifier
