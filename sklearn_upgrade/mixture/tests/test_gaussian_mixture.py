...
from sklearn_upgrade.covariance import EmpiricalCovariance
from sklearn_upgrade.datasets import make_spd_matrix
from sklearn_upgrade.datasets._samples_generator import make_blobs
...
from sklearn_upgrade.mixture._gaussian_mixture import (
...
def test_gaussian_mixture_log_probabilities():
    from sklearn_upgrade.mixture._gaussian_mixture import _estimate_log_gaussian_prob
...
def test_gaussian_mixture_all_init_does_not_estimate_gaussian_parameters(
    ...
    monkeypatch.setattr(
        sklearn_upgrade.mixture._gaussian_mixture, "_estimate_gaussian_parameters", mock
    )
...
def test_gaussian_mixture_array_api_compliance(
    ...
    with sklearn_upgrade.config_context(array_api_dispatch=True):
        gmm_xp = sklearn_upgrade.clone(gmm)
