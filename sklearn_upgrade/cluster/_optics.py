...
from sklearn_upgrade.metrics.pairwise import _VALID_METRICS, PAIRWISE_BOOLEAN_FUNCTIONS
from sklearn_upgrade.neighbors import NearestNeighbors
from sklearn_upgrade.utils import gen_batches
...
from sklearn_upgrade.utils.validation import check_memory, validate_data
...
class OPTICS(ClusterMixin, BaseEstimator):
    ...
    p : float, default=2
        ...
        :class:`~sklearn_upgrade.metrics.pairwise_distances`. When p = 1, this is
    ...
    algorithm : {'auto', 'ball_tree', 'kd_tree', 'brute'}, default='auto'
        ...
        - 'ball_tree' will use :class:`~sklearn_upgrade.neighbors.BallTree`.
        - 'kd_tree' will use :class:`~sklearn_upgrade.neighbors.KDTree`.
    ...
    leaf_size : int, default=30
        Leaf size passed to :class:`~sklearn_upgrade.neighbors.BallTree` or
        :class:`~sklearn_upgrade.neighbors.KDTree`. This can affect the speed of the
    ...
    Examples
    --------
    >>> from sklearn_upgrade.cluster import OPTICS
    >>> import numpy as np
...
def compute_optics_graph(
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.cluster import compute_optics_graph
    >>> X = np.array([[1, 2], [2, 5], [3, 6],
    ...               [8, 7], [8, 8], [7, 3]])
...
def cluster_optics_dbscan(*, reachability, core_distances, ordering, eps):
    ...
    ``labels_`` which are close to a :class:`~sklearn_upgrade.cluster.DBSCAN` with
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.cluster import cluster_optics_dbscan, compute_optics_graph
    >>> X = np.array([[1, 2], [2, 5], [3, 6],
    ...               [8, 7], [8, 8], [7, 3]])
    >>> ordering, core_distances, reachability, predecessor = compute_optics_graph(
    ...     X,
...
def cluster_optics_xi(
    *,
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.cluster import cluster_optics_xi, compute_optics_graph
    >>> X = np.array([[1, 2], [2, 5], [3, 6],
    ...               [8, 7], [8, 8], [7, 3]])
    >>> ordering, core_distances, reachability, predecessor = compute_optics_graph(
    ...     X,
