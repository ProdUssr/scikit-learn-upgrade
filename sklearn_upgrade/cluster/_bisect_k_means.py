...
from sklearn_upgrade.cluster._k_means_common import _inertia_dense, _inertia_sparse
from sklearn_upgrade.cluster._kmeans import (
    _BaseKMeans,
...
from sklearn_upgrade.utils._param_validation import Integral, Interval, StrOptions
...
class BisectingKMeans(_BaseKMeans):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.cluster import BisectingKMeans
    >>> import numpy as np
