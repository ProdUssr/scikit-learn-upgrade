...
from sklearn_upgrade.cluster import AgglomerativeClustering
from sklearn_upgrade.exceptions import ConvergenceWarning
from sklearn_upgrade.metrics import pairwise_distances_argmin
...
class Birch(
    ...
    n_clusters : int, instance of sklearn_upgrade.cluster model or None, default=3
        ...
        - :mod:`sklearn_upgrade.cluster` Estimator : If a model is provided, the model
    ...
    comparison with :class:`~sklearn_upgrade.cluster.MiniBatchKMeans`.
    ...
    * Roberto Perdisci
    ...
    Examples
    --------
    >>> from sklearn_upgrade.cluster import Birch
