...
from sklearn_upgrade.cluster._k_means_common import (
    CHUNK_SIZE,
    _inertia_dense,
    _inertia_sparse,
    _is_same_clustering,
)
from sklearn_upgrade.cluster._k_means_elkan import (
    elkan_iter_chunked_dense,
    elkan_iter_chunked_sparse,
    init_bounds_dense,
    init_bounds_sparse,
)
from sklearn_upgrade.cluster._k_means_lloyd import (
    lloyd_iter_chunked_dense,
    lloyd_iter_chunked_sparse,
)
from sklearn_upgrade.cluster._k_means_minibatch import (
    _minibatch_update_dense,
    _minibatch_update_sparse,
)
from sklearn_upgrade.exceptions import ConvergenceWarning
from sklearn_upgrade.metrics.pairwise import _euclidean_distances, euclidean_distances
from sklearn_upgrade.utils import check_array, check_random_state
...
from sklearn_upgrade.utils.parallel import (
...
from sklearn_upgrade.utils.sparsefuncs_fast import assign_rows_csr
...
def kmeans_plusplus(
    ...
    *,
    ...
    >>> from sklearn_upgrade.cluster import kmeans_plusplus
    >>> import numpy as np
...
def k_means(
    ...
    *,
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.cluster import k_means
    >>> X = np.array([[1, 2], [1, 4], [1, 0],
    ...               [10, 2], [10, 4], [10, 0]])
...
class MiniBatchKMeans(_BaseKMeans):
    ...
    comparison with :class:`~sklearn_upgrade.cluster.BIRCH`.
