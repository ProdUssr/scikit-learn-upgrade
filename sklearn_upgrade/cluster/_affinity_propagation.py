...
from sklearn_upgrade.metrics import euclidean_distances, pairwise_distances_argmin
...
def affinity_propagation(
    ...
    *,
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.cluster import affinity_propagation
...
class AffinityPropagation(ClusterMixin, BaseEstimator):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.cluster import AffinityPropagation
    >>> import numpy as np
    >>> X = np.array([[1, 2], [1, 4], [1, 0],
    ...               [4, 2], [4, 4], [4, 0]])
