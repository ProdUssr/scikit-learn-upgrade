...
# mypy error: Module 'sklearn_upgrade.cluster' has no attribute '_hierarchical_fast'
from sklearn_upgrade.cluster import (  # type: ignore[attr-defined]
    _hierarchical_fast as _hierarchical,
)
from sklearn_upgrade.cluster._feature_agglomeration import AgglomerationTransform
from sklearn_upgrade.metrics import DistanceMetric
from sklearn_upgrade.metrics._dist_metrics import METRIC_MAPPING64
from sklearn_upgrade.metrics.pairwise import _VALID_METRICS, paired_distances
...
def ward_tree(X, *, connectivity=None, n_clusters=None, return_distance=False):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.cluster import ward_tree
...
def linkage_tree(
    ...
    if connectivity is None:
        ...
        if affinity == "precomputed":
            ...
            # by sklearn_upgrade.metrics.pairwise_distances.
...
class AgglomerativeClustering(ClusterMixin, BaseEstimator):
    ...
    connectivity : array-like, sparse matrix, or callable, default=None
        ...
        :class:`~sklearn_upgrade.neighbors.kneighbors_graph`, see
...
class FeatureAgglomeration(
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade import datasets, cluster
