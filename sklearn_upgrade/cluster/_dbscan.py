...
from sklearn_upgrade.cluster._dbscan_inner import dbscan_inner
...
from sklearn_upgrade.utils.validation import _check_sample_weight, validate_data
...
def dbscan(
    ...
    *,
    ...
    algorithm : {'auto', 'ball_tree', 'kd_tree', 'brute'}, default='auto'
        ...
        See :class:`~sklearn_upgrade.neighbors.NearestNeighbors` documentation for
        details.
    ...
    <sklearn_upgrade.neighbors.NearestNeighbors.radius_neighbors_graph>` with
    ``mode='distance'``, then using ``metric='precomputed'`` here.

    Another way to reduce memory and computation time is to remove
    (near-)duplicate points and use ``sample_weight`` instead.

    :class:`~sklearn_upgrade.cluster.OPTICS` provides a similar clustering with lower
    memory usage.
    ...
    Examples
    --------
    >>> from sklearn_upgrade.cluster import dbscan
...
class DBSCAN(ClusterMixin, BaseEstimator):
    ...
    :class:`~sklearn_upgrade.cluster.OPTICS` provides a similar clustering with lower memory
    usage.
