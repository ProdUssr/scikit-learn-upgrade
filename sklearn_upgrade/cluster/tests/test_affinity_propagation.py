...
from sklearn_upgrade.cluster import AffinityPropagation, affinity_propagation
from sklearn_upgrade.cluster._affinity_propagation import _equal_similarities_and_preferences
