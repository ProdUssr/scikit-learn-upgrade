...
from sklearn_upgrade.cluster import SpectralClustering, spectral_clustering
from sklearn_upgrade.cluster._spectral import cluster_qr, discretize
from sklearn_upgrade.datasets import make_blobs
from sklearn_upgrade.feature_extraction import img_to_graph
from sklearn_upgrade.metrics import adjusted_rand_score
from sklearn_upgrade.metrics.pairwise import kernel_metrics, rbf_kernel
from sklearn_upgrade.neighbors import NearestNeighbors
from sklearn_upgrade.utils import check_random_state
from sklearn_upgrade.utils._testing import assert_array_equal
