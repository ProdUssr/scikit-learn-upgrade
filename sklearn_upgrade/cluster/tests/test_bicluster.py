...
from sklearn_upgrade.base import BaseEstimator, BiclusterMixin, clone
from sklearn_upgrade.cluster import SpectralBiclustering, SpectralCoclustering
from sklearn_upgrade.cluster._bicluster import (
    _bistochastic_normalize,
    _log_normalize,
    _scale_normalize,
)
from sklearn_upgrade.datasets import make_biclusters, make_checkerboard
from sklearn_upgrade.metrics import consensus_score, v_measure_score
