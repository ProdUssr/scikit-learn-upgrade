...
from sklearn_upgrade.cluster import DBSCAN, OPTICS
from sklearn_upgrade.cluster._optics import _extend_region, _extract_xi_labels
from sklearn_upgrade.cluster.tests.common import generate_clustered_data
...
def test_compare_to_ELKI():
    ...
    # Does NOT work with metric='euclidean', because sklearn_upgrade euclidean has
