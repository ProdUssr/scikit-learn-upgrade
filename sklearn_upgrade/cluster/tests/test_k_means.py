...
from sklearn_upgrade.cluster import KMeans, MiniBatchKMeans, k_means, kmeans_plusplus
...
from sklearn_upgrade.cluster._kmeans import _labels_inertia, _mini_batch_step
from sklearn_upgrade.datasets import make_blobs
from sklearn_upgrade.exceptions import ConvergenceWarning
from sklearn_upgrade.metrics import pairwise_distances, pairwise_distances_argmin
...
from sklearn_upgrade.utils.fixes import CSR_CONTAINERS, _sparse_random_array
from sklearn_upgrade.utils.parallel import _get_threadpool_controller
