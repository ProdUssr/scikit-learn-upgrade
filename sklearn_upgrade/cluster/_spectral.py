...
from sklearn_upgrade.cluster._kmeans import k_means
from sklearn_upgrade.manifold._spectral_embedding import _spectral_embedding
from sklearn_upgrade.metrics.pairwise import KERNEL_PARAMS, pairwise_kernels
from sklearn_upgrade.neighbors import NearestNeighbors, kneighbors_graph
from sklearn_upgrade.utils import as_float_array, check_random_state
...
def spectral_clustering(
    ...
    *,
    ...
    >>> from sklearn_upgrade.cluster import spectral_clustering
...
class SpectralClustering(ClusterMixin, BaseEstimator):
    ...
    affinity : str or callable, default='rbf'
        How to construct the affinity matrix.
         ...
         - one of the kernels supported by
           :func:`~sklearn_upgrade.metrics.pairwise.pairwise_kernels`.
    ...
    See Also
    --------
    sklearn_upgrade.cluster.KMeans : K-Means clustering.
    sklearn_upgrade.cluster.DBSCAN : Density-Based Spatial Clustering of
    ...
    Examples
    --------
    >>> from sklearn_upgrade.cluster import SpectralClustering
    >>> import numpy as np
    >>> X = np.array([[1, 1], [2, 1], [1, 0],
    ...               [4, 7], [3, 5], [3, 6]])
