...
from sklearn_upgrade.utils._fast_dict cimport IntFloatDict
from sklearn_upgrade.utils._typedefs cimport float64_t, intp_t, uint8_t
...
def mst_linkage_core(
    ...
    dist_metric: DistanceMetric64
        ...
        ``sklearn_upgrade.metrics._dist_metrics.pxd`` that will be
