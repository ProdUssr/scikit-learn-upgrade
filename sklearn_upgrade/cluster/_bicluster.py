...
from sklearn_upgrade.base import BaseEstimator, BiclusterMixin, _fit_context
from sklearn_upgrade.cluster._kmeans import KMeans, MiniBatchKMeans
from sklearn_upgrade.utils import check_random_state, check_scalar
from sklearn_upgrade.utils._param_validation import Interval, StrOptions
from sklearn_upgrade.utils.extmath import _randomized_svd, make_nonnegative, safe_sparse_dot
from sklearn_upgrade.utils.validation import assert_all_finite, validate_data
...
class SpectralCoclustering(BaseSpectral):
    ...
    svd_method : {'randomized', 'arpack'}, default='randomized'
        ...
        :func:`sklearn_upgrade.utils.extmath.randomized_svd`, which may be faster
    ...
    Examples
    --------
    >>> from sklearn_upgrade.cluster import SpectralCoclustering
    >>> import numpy as np
...
class SpectralBiclustering(BaseSpectral):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.cluster import SpectralBiclustering
    >>> import numpy as np
    >>> X = np.array([[1, 1], [2, 1], [1, 0],
    ...               [4, 7], [3, 5], [3, 6]])
