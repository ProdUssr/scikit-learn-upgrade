...
from sklearn_upgrade.utils import check_random_state
from sklearn_upgrade.utils._param_validation import HasMethods, Interval
...
from sklearn_upgrade.utils.metaestimators import _safe_split, available_if
from sklearn_upgrade.utils.multiclass import (
...
class OneVsRestClassifier(
    ...
    sklearn_upgrade.multioutput.MultiOutputClassifier : Alternate way of extending an
        estimator for multilabel classification.
    sklearn_upgrade.preprocessing.MultiLabelBinarizer : Transform iterable of iterables
...
class OneVsOneClassifier(MetaEstimatorMixin, ClassifierMixin, BaseEstimator):
    ...
    def fit(self, X, y, **fit_params):
        ...
        **fit_params : dict
        ...
        pairwise = self.__sklearn_upgrade_tags__().input_tags.pairwise
...
class OutputCodeClassifier(MetaEstimatorMixin, ClassifierMixin, BaseEstimator):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.multiclass import OutputCodeClassifier
