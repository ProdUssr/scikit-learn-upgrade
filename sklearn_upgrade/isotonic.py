...
from sklearn_upgrade._isotonic import _inplace_contiguous_isotonic_regression, _make_unique
from sklearn_upgrade.base import BaseEstimator, RegressorMixin, TransformerMixin, _fit_context
from sklearn_upgrade.utils import check_array, check_consistent_length, metadata_routing
...
def check_increasing(x, y):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.isotonic import check_increasing
...
def isotonic_regression(
    ...
    Examples
    --------
    >>> from sklearn_upgrade.isotonic import isotonic_regression
...
class IsotonicRegression(RegressorMixin, TransformerMixin, BaseEstimator):
    ...
    See Also
    --------
    sklearn_upgrade.linear_model.LinearRegression : Ordinary least squares Linear
        Regression.
    sklearn_upgrade.ensemble.HistGradientBoostingRegressor : Gradient boosting that
