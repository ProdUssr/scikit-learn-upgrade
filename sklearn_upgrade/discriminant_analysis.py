...
from sklearn_upgrade.covariance import empirical_covariance, ledoit_wolf, shrunk_covariance
...
from sklearn_upgrade.utils.multiclass import check_classification_targets, unique_labels
...
def _cov(X, shrinkage=None, covariance_estimator=None):
    ...
    covariance_estimator : estimator, default=None
        ...
        like the estimators in :mod:`sklearn_upgrade.covariance``.
...
def _class_cov(X, y, priors, shrinkage=None, covariance_estimator=None):
    ...
    covariance_estimator : estimator, default=None
        ...
        covariance estimator (with potential shrinkage).
        The object should have a fit method and a ``covariance_`` attribute
        like the estimators in sklearn_upgrade.covariance.
        If None, the shrinkage parameter drives the estimate.
...
class LinearDiscriminantAnalysis(
    ...
    :class:`~sklearn_upgrade.discriminant_analysis.LinearDiscriminantAnalysis`
    and :class:`~sklearn_upgrade.discriminant_analysis.QuadraticDiscriminantAnalysis`, see
...
class QuadraticDiscriminantAnalysis(
    ...
    For a comparison between
    :class:`~sklearn_upgrade.discriminant_analysis.QuadraticDiscriminantAnalysis`
    and :class:`~sklearn_upgrade.discriminant_analysis.LinearDiscriminantAnalysis`, see
    :ref:`sphx_glr_auto_examples_classification_plot_lda_qda.py`.
    ...
    covariance_estimator : covariance estimator, default=None
        ...
        :mod:`sklearn_upgrade.covariance`. If None the shrinkage parameter drives the
        estimate.
    ...
    Examples
    --------
    >>> from sklearn_upgrade.discriminant_analysis import QuadraticDiscriminantAnalysis
    >>> import numpy as np
    >>> X = np.array([[-1, -1], [-2, -1], [-3, -2], [1, 1], [2, 1], [3, 2]])
    >>> y = np.array([1, 1, 1, 2, 2, 2])
