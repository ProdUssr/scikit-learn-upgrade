...
from sklearn_upgrade.base import is_classifier, is_regressor
from sklearn_upgrade.ensemble import RandomForestRegressor
from sklearn_upgrade.ensemble._gb import BaseGradientBoosting
...
from sklearn_upgrade.utils import Bunch, _safe_indexing, check_array
from sklearn_upgrade.utils._indexing import (
    _determine_key_type,
    _get_column_indices,
    _safe_assign,
)
from sklearn_upgrade.utils._optional_dependencies import check_matplotlib_support  # noqa: F401
...
from sklearn_upgrade.utils._response import _get_response_values
from sklearn_upgrade.utils.extmath import cartesian
from sklearn_upgrade.utils.validation import _check_sample_weight, check_is_fitted
...
def _partial_dependence_recursion(est, grid, features):
    ...
    (:func:`~sklearn_upgrade.inspection._partial_dependence._partial_dependence_brute`).
...
def _partial_dependence_brute(
    ...
    (:func:`~sklearn_upgrade.inspection._partial_dependence._partial_dependence_recursion`)
...
def partial_dependence(
    ...
    *,
    ...
    Returns
    -------
    predictions : :class:`~sklearn_upgrade.utils.Bunch`
