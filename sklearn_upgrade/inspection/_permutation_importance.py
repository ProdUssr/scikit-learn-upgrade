...
from sklearn_upgrade.ensemble._bagging import _generate_indices
from sklearn_upgrade.metrics import check_scoring, get_scorer_names
from sklearn_upgrade.model_selection._validation import _aggregate_score_dicts
...
def _create_importances_bunch(baseline_score, permuted_score):
    ...
    Returns
    -------
    importances : :class:`~sklearn_upgrade.utils.Bunch`
...
def permutation_importance(
    ...
    *,
    ...
    Returns
    -------
    result : :class:`~sklearn_upgrade.utils.Bunch` or dict of such instances
        Dictionary-like object, with the following attributes.
