...
from sklearn_upgrade.inspection._plot.decision_boundary import _check_boundary_response_method
...
from sklearn_upgrade.utils.fixes import PETROFF_COLORS, parse_version
