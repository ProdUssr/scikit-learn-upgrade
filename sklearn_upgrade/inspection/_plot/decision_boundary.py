...
from sklearn_upgrade.base import is_classifier, is_clusterer, is_outlier_detector, is_regressor
from sklearn_upgrade.preprocessing import LabelEncoder
from sklearn_upgrade.utils import _safe_indexing
from sklearn_upgrade.utils._dataframe import is_pandas_df, is_polars_df
...
from sklearn_upgrade.utils._set_output import _get_adapter_from_container
from sklearn_upgrade.utils.fixes import PETROFF_COLORS
...
class DecisionBoundaryDisplay:
    ...
    :func:`~sklearn_upgrade.inspection.DecisionBoundaryDisplay.from_estimator`
    ...
    >>> from sklearn_upgrade.inspection import DecisionBoundaryDisplay
    ...
    def plot(self, plot_method="contourf", ax=None, xlabel=None, ylabel=None, **kwargs):
        ...
        **kwargs : dict
        ...
        Returns
        -------
        display: :class:`~sklearn_upgrade.inspection.DecisionBoundaryDisplay`
    ...
    def from_estimator(
        ...
        **kwargs : dict
        ...
        sklearn_upgrade.metrics.ConfusionMatrixDisplay.from_estimator : Plot the
            confusion matrix given an estimator, the data, and the label.
        sklearn_upgrade.metrics.ConfusionMatrixDisplay.from_predictions : Plot the
