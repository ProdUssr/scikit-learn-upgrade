...
from sklearn_upgrade.inspection import partial_dependence
from sklearn_upgrade.inspection._pd_utils import _check_feature_names, _get_feature_index
from sklearn_upgrade.utils import Bunch, _safe_indexing, check_array, check_random_state
from sklearn_upgrade.utils._encode import _unique
from sklearn_upgrade.utils._optional_dependencies import check_matplotlib_support
from sklearn_upgrade.utils._plotting import _validate_style_kwargs
...
class PartialDependenceDisplay:
    ...
    :func:`~sklearn_upgrade.inspection.PartialDependenceDisplay.from_estimator` to create a
    :class:`~sklearn_upgrade.inspection.PartialDependenceDisplay`. All parameters are stored
    as attributes.
    ...
    pd_results : list of Bunch
        Results of :func:`~sklearn_upgrade.inspection.partial_dependence` for
        ``features``.
    ...
    >>> from sklearn_upgrade.datasets import make_friedman1
    >>> from sklearn_upgrade.ensemble import GradientBoostingRegressor
    >>> from sklearn_upgrade.inspection import PartialDependenceDisplay
    >>> from sklearn_upgrade.inspection import partial_dependence
    >>> X, y = make_friedman1()
    ...
    def from_estimator(
        ...
        *,
        ...
        .. warning::
            ...
            For :class:`~sklearn_upgrade.ensemble.GradientBoostingClassifier` and
            :class:`~sklearn_upgrade.ensemble.GradientBoostingRegressor`, the
            ...
            :class:`~sklearn_upgrade.ensemble.GradientBoostingClassifier` and
            :class:`~sklearn_upgrade.ensemble.GradientBoostingRegressor`, not to
            :class:`~sklearn_upgrade.ensemble.HistGradientBoostingClassifier` and
            :class:`~sklearn_upgrade.ensemble.HistGradientBoostingRegressor`.
        ...
        method : str, default='auto'
            ...
            - `'recursion'` is only supported for some tree-based estimators
              (namely
              :class:`~sklearn_upgrade.ensemble.GradientBoostingClassifier`,
              :class:`~sklearn_upgrade.ensemble.GradientBoostingRegressor`,
              :class:`~sklearn_upgrade.ensemble.HistGradientBoostingClassifier`,
              :class:`~sklearn_upgrade.ensemble.HistGradientBoostingRegressor`,
              :class:`~sklearn_upgrade.tree.DecisionTreeRegressor`,
              :class:`~sklearn_upgrade.ensemble.RandomForestRegressor`
        ...
        Returns
        -------
        display : :class:`~sklearn_upgrade.inspection.PartialDependenceDisplay`
    ...
    def plot(
        ...
        *,
        ...
        -------
        display : :class:`~sklearn_upgrade.inspection.PartialDependenceDisplay`
            Returns a :class:`~sklearn_upgrade.inspection.PartialDependenceDisplay`
