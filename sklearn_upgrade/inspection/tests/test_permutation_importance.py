...
from sklearn_upgrade.ensemble import RandomForestClassifier, RandomForestRegressor
from sklearn_upgrade.impute import SimpleImputer
from sklearn_upgrade.inspection import permutation_importance
...
from sklearn_upgrade.preprocessing import KBinsDiscretizer, OneHotEncoder, StandardScaler, scale
