...
from sklearn_upgrade.base import BaseEstimator, ClassifierMixin, clone, is_regressor
from sklearn_upgrade.cluster import KMeans
from sklearn_upgrade.compose import make_column_transformer
from sklearn_upgrade.datasets import load_iris, make_classification, make_regression
...
from sklearn_upgrade.inspection._partial_dependence import (
    _grid_from_X,
    _partial_dependence_brute,
    _partial_dependence_recursion,
)
from sklearn_upgrade.linear_model import LinearRegression, LogisticRegression, MultiTaskLasso
...
from sklearn_upgrade.tree.tests.test_tree import assert_is_subtree
from sklearn_upgrade.utils._testing import assert_allclose, assert_array_equal
...
@pytest.mark.parametrize(
    "Estimator",
    (
        sklearn_upgrade.tree.DecisionTreeClassifier,
        sklearn_upgrade.tree.ExtraTreeClassifier,
        sklearn_upgrade.ensemble.ExtraTreesClassifier,
        sklearn_upgrade.neighbors.KNeighborsClassifier,
        sklearn_upgrade.neighbors.RadiusNeighborsClassifier,
        sklearn_upgrade.ensemble.RandomForestClassifier,
    ),
)
...
def test_mixed_type_categorical():
    ...
    from sklearn_upgrade.preprocessing import OrdinalEncoder
