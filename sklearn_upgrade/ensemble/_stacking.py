...
from sklearn_upgrade.ensemble._base import _BaseHeterogeneousEnsemble, _fit_single_estimator
from sklearn_upgrade.exceptions import NotFittedError
from sklearn_upgrade.linear_model import LogisticRegression, RidgeCV
from sklearn_upgrade.model_selection import check_cv, cross_val_predict
from sklearn_upgrade.preprocessing import LabelEncoder
from sklearn_upgrade.utils import Bunch
from sklearn_upgrade.utils._param_validation import HasMethods, StrOptions
from sklearn_upgrade.utils._repr_html.estimator import _VisualBlock
...
from sklearn_upgrade.utils.metaestimators import available_if
...
class StackingClassifier(ClassifierMixin, _BaseStacking):
    ...
    final_estimator : estimator, default=None
        ...
        :class:`~sklearn_upgrade.linear_model.LogisticRegression`.
    ...
    cv : int, cross-validation generator, iterable, or "prefit", default=None
        ...
        * `"prefit"`, to assume the `estimators` are prefit. In this case, the
        ...
        :class:`~sklearn_upgrade.model_selection.StratifiedKFold` is used.
        In all other cases, :class:`~sklearn_upgrade.model_selection.KFold` is used.
    ...
    named_estimators_ : :class:`~sklearn_upgrade.utils.Bunch`
    ...
    >>> from sklearn_upgrade.ensemble import StackingClassifier
    ...
    def fit(self, X, y, **fit_params):
        ...
        **fit_params : dict
            ...
            .. versionadded:: 1.6
                ...
                set by using ``sklearn_upgrade.set_config(enable_metadata_routing=True)``.
...
class StackingRegressor(RegressorMixin, _BaseStacking):
    ...
    final_estimator : estimator, default=None
        ...
        The default regressor is a :class:`~sklearn_upgrade.linear_model.RidgeCV`.
    ...
    >>> from sklearn_upgrade.linear_model import RidgeCV
    >>> from sklearn_upgrade.svm import LinearSVR
    >>> from sklearn_upgrade.ensemble import RandomForestRegressor
    >>> from sklearn_upgrade.ensemble import StackingRegressor
