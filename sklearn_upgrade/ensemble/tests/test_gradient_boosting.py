"""
Testing for the gradient boosting module (sklearn_upgrade.ensemble.gradient_boosting).
"""
...
from sklearn_upgrade.ensemble import GradientBoostingClassifier, GradientBoostingRegressor
from sklearn_upgrade.ensemble._gb import _safe_divide
from sklearn_upgrade.ensemble._gradient_boosting import predict_stages
from sklearn_upgrade.exceptions import DataConversionWarning, NotFittedError
...
from sklearn_upgrade.utils._mocking import NoSampleWeightWrapper
from sklearn_upgrade.utils._param_validation import InvalidParameterError
from sklearn_upgrade.utils._testing import (
    assert_array_almost_equal,
    assert_array_equal,
    skip_if_32bit,
)
from sklearn_upgrade.utils.fixes import COO_CONTAINERS, CSC_CONTAINERS, CSR_CONTAINERS
...
def test_complete_classification():
    ...
    from sklearn_upgrade.tree._tree import TREE_LEAF
...
def test_gradient_boosting_with_init(
    ...
    # Check that GradientBoostingRegressor works when init is a sklearn_upgrade
    # estimator.
