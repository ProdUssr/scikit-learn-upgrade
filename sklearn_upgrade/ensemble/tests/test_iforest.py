"""
Testing for Isolation Forest algorithm (sklearn_upgrade.ensemble.iforest).
"""
...
from sklearn_upgrade.datasets import load_diabetes, load_iris, make_classification
from sklearn_upgrade.ensemble import IsolationForest
from sklearn_upgrade.ensemble._iforest import _average_path_length
from sklearn_upgrade.metrics import roc_auc_score
from sklearn_upgrade.model_selection import ParameterGrid, train_test_split
...
# chunk has 3 rows):
@patch(
    "sklearn_upgrade.ensemble._iforest.get_chunk_n_rows",
