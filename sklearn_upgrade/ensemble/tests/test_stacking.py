...
from sklearn_upgrade.base import BaseEstimator, ClassifierMixin, RegressorMixin, clone
...
from sklearn_upgrade.model_selection import KFold, StratifiedKFold, train_test_split
...
from sklearn_upgrade.svm import SVC, LinearSVC, LinearSVR
