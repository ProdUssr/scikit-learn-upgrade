"""
Testing for the forest module (sklearn_upgrade.ensemble.forest).
"""
...
from sklearn_upgrade import clone, datasets
from sklearn_upgrade.datasets import make_classification, make_hastie_10_2, make_regression
from sklearn_upgrade.decomposition import TruncatedSVD
...
from sklearn_upgrade.ensemble._forest import _generate_unsampled_indices
...
from sklearn_upgrade.tree._classes import SPARSE_SPLITTERS
...
from sklearn_upgrade.utils.parallel import Parallel
...
def test_mse_criterion_object_segfault_smoke_test(Forest):
    ...
    from sklearn_upgrade.tree._criterion import MSE
...
def test_read_only_buffer(csr_container, monkeypatch):
    ...
    """
    monkeypatch.setattr(
        sklearn_upgrade.ensemble._forest,
        "Parallel",
