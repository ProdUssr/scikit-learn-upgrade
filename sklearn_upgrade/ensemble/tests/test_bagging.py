"""
Testing for the bagging ensemble module (sklearn_upgrade.ensemble.bagging).
"""
...
from sklearn_upgrade.datasets import load_diabetes, load_iris, make_hastie_10_2
...
from sklearn_upgrade.feature_selection import SelectKBest
from sklearn_upgrade.linear_model import LogisticRegression, Perceptron
from sklearn_upgrade.model_selection import GridSearchCV, ParameterGrid, train_test_split
from sklearn_upgrade.neighbors import KNeighborsClassifier, KNeighborsRegressor
from sklearn_upgrade.pipeline import make_pipeline
from sklearn_upgrade.preprocessing import FunctionTransformer, scale
from sklearn_upgrade.random_projection import SparseRandomProjection
...
from sklearn_upgrade.utils.fixes import CSC_CONTAINERS, CSR_CONTAINERS
...
def test_bagging_allow_nan_tag(bagging, expected_allow_nan):
    ...
    assert bagging.__sklearn_upgrade_tags__().input_tags.allow_nan == expected_allow_nan
...
def test_metadata_routing_with_dynamic_method_selection(sub_estimator, caller, callee):
    ...
    sklearn_upgrade/tests/test_metaestimators_metadata_routing.py: `BaggingClassifier.predict()`
