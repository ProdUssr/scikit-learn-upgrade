...
from sklearn_upgrade.base import ClassifierMixin, RegressorMixin, _fit_context
...
from sklearn_upgrade.utils import Bunch, _safe_indexing, check_random_state, column_or_1d
from sklearn_upgrade.utils._mask import indices_to_mask
from sklearn_upgrade.utils._param_validation import HasMethods, Interval, RealNotInt
...
from sklearn_upgrade.utils.random import sample_without_replacement
...
class BaggingClassifier(ClassifierMixin, BaseBagging):
    ...
    estimator : object, default=None
        ...
        :class:`~sklearn_upgrade.tree.DecisionTreeClassifier`.
    ...
    def predict(self, X, **params):
        ...
        **params : dict
            ...
            .. versionadded:: 1.7
                ...
                Only available if
                `sklearn_upgrade.set_config(enable_metadata_routing=True)` is set. See
