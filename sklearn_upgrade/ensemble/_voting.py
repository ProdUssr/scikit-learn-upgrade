...
from sklearn_upgrade.utils._param_validation import StrOptions
...
class VotingClassifier(ClassifierMixin, _BaseVoting):
    ...
    le_ : :class:`~sklearn_upgrade.preprocessing.LabelEncoder`
    ...
    >>> from sklearn_upgrade.ensemble import RandomForestClassifier, VotingClassifier
...
class VotingRegressor(RegressorMixin, _BaseVoting):
    ...
    >>> from sklearn_upgrade.ensemble import VotingRegressor
