...
from sklearn_upgrade.base import OutlierMixin, _fit_context
from sklearn_upgrade.ensemble._bagging import BaseBagging
from sklearn_upgrade.tree import ExtraTreeRegressor
from sklearn_upgrade.tree._tree import DTYPE as tree_dtype
from sklearn_upgrade.utils import check_array, check_random_state, gen_batches
...
class IsolationForest(OutlierMixin, BaseBagging):
    ...
    See Also
    --------
    sklearn_upgrade.covariance.EllipticEnvelope : An object for detecting outliers in a
        Gaussian distributed dataset.
    sklearn_upgrade.svm.OneClassSVM : Unsupervised Outlier Detection.
        Estimate the support of a high-dimensional distribution.
        The implementation is based on libsvm.
    sklearn_upgrade.neighbors.LocalOutlierFactor : Unsupervised Outlier Detection
    ...
    Examples
    --------
    >>> from sklearn_upgrade.ensemble import IsolationForest
    >>> X = [[-1.1], [0.3], [0.5], [100]]
    ...
    def _compute_chunked_score_samples(self, X):
        ...
        # (defined by sklearn_upgrade.get_config()['working_memory']) to store
