...
- :class:`~sklearn_upgrade.ensemble.AdaBoostClassifier` implements adaptive boosting
  (AdaBoost-SAMME) for classification problems.

- :class:`~sklearn_upgrade.ensemble.AdaBoostRegressor` implements adaptive boosting
...
from sklearn_upgrade.utils import _safe_indexing, check_random_state
...
class AdaBoostClassifier(
    ...
    estimator : object, default=None
        ...
        the base estimator is :class:`~sklearn_upgrade.tree.DecisionTreeClassifier`
    ...
    sklearn_upgrade.tree.DecisionTreeClassifier : A non-parametric supervised learning
    ...
    Examples
    --------
    >>> from sklearn_upgrade.ensemble import AdaBoostClassifier
...
class AdaBoostRegressor(_RoutingNotSupportedMixin, RegressorMixin, BaseWeightBoosting):
    ...
    estimator : object, default=None
        ...
        :class:`~sklearn_upgrade.tree.DecisionTreeRegressor` initialized with
        `max_depth=3`.
    ...
    Examples
    --------
    >>> from sklearn_upgrade.ensemble import AdaBoostRegressor
    ...
    For a detailed example of utilizing :class:`~sklearn_upgrade.ensemble.AdaBoostRegressor`
