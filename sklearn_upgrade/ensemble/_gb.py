...
from sklearn_upgrade._loss.loss import (
    _LOSSES,
    AbsoluteError,
    ExponentialLoss,
    HalfBinomialLoss,
...
from sklearn_upgrade.base import ClassifierMixin, RegressorMixin, _fit_context, is_classifier
from sklearn_upgrade.dummy import DummyClassifier, DummyRegressor
from sklearn_upgrade.ensemble._base import BaseEnsemble
from sklearn_upgrade.ensemble._gradient_boosting import (
    _random_sample_mask,
    predict_stage,
    predict_stages,
)
...
from sklearn_upgrade.tree._tree import DOUBLE, DTYPE, TREE_LEAF
from sklearn_upgrade.utils import check_array, check_random_state, column_or_1d
from sklearn_upgrade.utils._param_validation import HasMethods, Hidden, Interval, StrOptions
from sklearn_upgrade.utils.multiclass import check_classification_targets
from sklearn_upgrade.utils.stats import _weighted_percentile
...
class BaseGradientBoosting(BaseEnsemble, metaclass=ABCMeta):
    ...
    def _get_loss(self, sample_weight):
        """Get loss object from sklearn_upgrade._loss.loss."""
...
class GradientBoostingClassifier(ClassifierMixin, BaseGradientBoosting):
    ...
    :class:`~sklearn_upgrade.ensemble.HistGradientBoostingClassifier` is a much faster variant
    ...
    >>> from sklearn_upgrade.datasets import make_hastie_10_2
    >>> from sklearn_upgrade.ensemble import GradientBoostingClassifier
...
class GradientBoostingRegressor(RegressorMixin, BaseGradientBoosting):
    ...
    :class:`~sklearn_upgrade.ensemble.HistGradientBoostingRegressor` is a much faster variant
    of this algorithm for intermediate and large datasets (`n_samples >= 10_000`) and
    supports monotonic constraints.
    ...
    sklearn_upgrade.ensemble.RandomForestRegressor : A random forest regressor.
