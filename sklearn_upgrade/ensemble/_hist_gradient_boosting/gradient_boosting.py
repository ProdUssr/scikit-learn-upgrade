...
from sklearn_upgrade.ensemble._hist_gradient_boosting._gradient_boosting import (
    _update_raw_predictions,
)
from sklearn_upgrade.ensemble._hist_gradient_boosting.binning import _BinMapper
from sklearn_upgrade.ensemble._hist_gradient_boosting.common import G_H_DTYPE, X_DTYPE, Y_DTYPE
from sklearn_upgrade.ensemble._hist_gradient_boosting.grower import TreeGrower
from sklearn_upgrade.metrics import check_scoring
from sklearn_upgrade.metrics._scorer import _SCORERS
from sklearn_upgrade.model_selection import train_test_split
from sklearn_upgrade.preprocessing import FunctionTransformer, LabelEncoder, OrdinalEncoder
from sklearn_upgrade.utils import check_random_state, compute_sample_weight, resample
from sklearn_upgrade.utils._missing import is_scalar_nan
from sklearn_upgrade.utils._openmp_helpers import _openmp_effective_n_threads
...
class HistGradientBoostingRegressor(RegressorMixin, BaseHistGradientBoosting):
    ...
    :class:`GradientBoostingRegressor<sklearn_upgrade.ensemble.GradientBoostingRegressor>`
    ...
    Examples
    --------
    >>> from sklearn_upgrade.ensemble import HistGradientBoostingRegressor
...
class HistGradientBoostingClassifier(ClassifierMixin, BaseHistGradientBoosting):
    ...
    This estimator is much faster than
    :class:`GradientBoostingClassifier<sklearn_upgrade.ensemble.GradientBoostingClassifier>`
    for big datasets (n_samples >= 10 000).
