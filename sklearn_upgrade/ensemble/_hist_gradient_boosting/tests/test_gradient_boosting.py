...
import sklearn_upgrade.ensemble._hist_gradient_boosting.gradient_boosting as hgb_module
...
from sklearn_upgrade.base import BaseEstimator, TransformerMixin, clone, is_regressor
from sklearn_upgrade.compose import make_column_transformer
from sklearn_upgrade.datasets import make_classification, make_low_rank_matrix, make_regression
...
from sklearn_upgrade.ensemble._hist_gradient_boosting.common import G_H_DTYPE
from sklearn_upgrade.ensemble._hist_gradient_boosting.grower import TreeGrower
from sklearn_upgrade.ensemble._hist_gradient_boosting.predictor import TreePredictor
from sklearn_upgrade.exceptions import NotFittedError
from sklearn_upgrade.metrics import get_scorer, mean_gamma_deviance, mean_poisson_deviance
from sklearn_upgrade.model_selection import cross_val_score, train_test_split
from sklearn_upgrade.pipeline import make_pipeline
from sklearn_upgrade.preprocessing import KBinsDiscretizer, MinMaxScaler, OneHotEncoder
from sklearn_upgrade.utils import check_random_state, shuffle
from sklearn_upgrade.utils._openmp_helpers import _openmp_effective_n_threads
from sklearn_upgrade.utils._testing import _convert_container
...
def get_different_bitness_node_ndarray(node_ndarray):
    ...
    # sklearn_upgrade/ensemble/_hist_gradient_boosting/common.pyx)
