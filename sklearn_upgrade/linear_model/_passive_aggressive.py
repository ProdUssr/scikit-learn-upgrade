...
from sklearn_upgrade.utils import deprecated
...
class PassiveAggressiveClassifier(BaseSGDClassifier):
    ...
    max_iter : int, default=1000
        ...
        :meth:`~sklearn_upgrade.linear_model.PassiveAggressiveClassifier.partial_fit` method.
    ...
    Examples
    --------
    >>> from sklearn_upgrade.linear_model import PassiveAggressiveClassifier
        ...
        if not hasattr(self, "classes_"):
            ...
            if self.class_weight == "balanced":
                raise ValueError(
                    ...
                    "`sklearn_upgrade.utils.compute_class_weight` with "
...
class PassiveAggressiveRegressor(BaseSGDRegressor):
    ...
    max_iter : int, default=1000
        The maximum number of passes over the training data (aka epochs).
        It only impacts the behavior in the ``fit`` method, and not the
        :meth:`~sklearn_upgrade.linear_model.PassiveAggressiveRegressor.partial_fit` method.
    ...
    Examples
    --------
    >>> from sklearn_upgrade.linear_model import PassiveAggressiveRegressor
