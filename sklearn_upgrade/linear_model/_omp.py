...
from sklearn_upgrade.linear_model._base import LinearModel, MultiOutputLinearModel, _pre_fit
from sklearn_upgrade.model_selection import check_cv
from sklearn_upgrade.utils import Bunch, as_float_array, check_array
...
from sklearn_upgrade.utils.validation import FLOAT_DTYPES, validate_data
...
def orthogonal_mp(
    ...
    *,
    ...
    >>> from sklearn_upgrade.linear_model import orthogonal_mp
...
def orthogonal_mp_gram(
    ...
    *,
    ...
    lars_path : Compute Least Angle Regression or Lasso path using
        LARS algorithm.
    sklearn_upgrade.decomposition.sparse_encode : Generic sparse coding.
    ...
    --------
    >>> from sklearn_upgrade.datasets import make_regression
    >>> from sklearn_upgrade.linear_model import orthogonal_mp_gram
    >>> X, y = make_regression(noise=4, random_state=0)
...
class OrthogonalMatchingPursuit(RegressorMixin, MultiOutputLinearModel):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.linear_model import OrthogonalMatchingPursuit
    >>> from sklearn_upgrade.datasets import make_regression
    >>> X, y = make_regression(noise=4, random_state=0)
...
class OrthogonalMatchingPursuitCV(RegressorMixin, LinearModel):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.linear_model import OrthogonalMatchingPursuitCV
    >>> from sklearn_upgrade.datasets import make_regression
