...
from sklearn_upgrade.utils import _align_api_if_sparse, check_array, check_random_state
...
from sklearn_upgrade.utils._seq_dataset import (
    ArrayDataset32,
    ArrayDataset64,
    CSRDataset32,
    CSRDataset64,
    ...
    def fit(self, X, y, sample_weight=None):
        ...
        if self.positive:
            ...
            try:
                ...
                print(f"Cholesky failed ({e}), falling back to SVD")
