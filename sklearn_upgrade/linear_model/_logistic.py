...
from sklearn_upgrade.base import _fit_context
from sklearn_upgrade.linear_model._base import (
    BaseEstimator,
    LinearClassifierMixin,
    SparseCoefMixin,
)
from sklearn_upgrade.linear_model._glm.glm import NewtonCholeskySolver
from sklearn_upgrade.linear_model._linear_loss import LinearModelLoss
from sklearn_upgrade.linear_model._sag import sag_solver
from sklearn_upgrade.metrics import get_scorer, get_scorer_names, make_scorer
from sklearn_upgrade.model_selection import check_cv
from sklearn_upgrade.preprocessing import LabelEncoder
from sklearn_upgrade.svm._base import _fit_liblinear
...
from sklearn_upgrade.utils._param_validation import Hidden, Interval, StrOptions
from sklearn_upgrade.utils.extmath import row_norms, softmax
from sklearn_upgrade.utils.fixes import _get_additional_lbfgs_options_dict
...
from sklearn_upgrade.utils.optimize import _check_optimize_result, _newton_cg
...
class LogisticRegression(LinearClassifierMixin, SparseCoefMixin, BaseEstimator):
    ...
    :class:`~sklearn_upgrade.multiclass.OneVsRestClassifier`.
    ...
    solver : {'lbfgs', 'liblinear', 'newton-cg', 'newton-cholesky', 'sag', 'saga'}, \
        ...
        .. note::
           ...
           a scaler from :mod:`sklearn_upgrade.preprocessing`.
...
class LogisticRegressionCV(LogisticRegression, LinearClassifierMixin, BaseEstimator):
    ...
    :class:`~sklearn_upgrade.model_selection.StratifiedKFold`, but it can be changed
    ...
    cv : int or cross-validation generator, default=None
        ...
        See the module :mod:`sklearn_upgrade.model_selection` module for the
