...
from sklearn_upgrade.datasets import load_diabetes, make_regression
...
from sklearn_upgrade.linear_model._coordinate_descent import _set_order
...
from sklearn_upgrade.utils import check_array
...
def test_lassoCV_does_not_set_precompute(monkeypatch, precompute, inner_precompute):
    ...
    monkeypatch.setattr("sklearn_upgrade.linear_model._coordinate_descent.Lasso", LassoMock)
