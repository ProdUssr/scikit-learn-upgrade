...
from sklearn_upgrade.base import ClassifierMixin
...
from sklearn_upgrade.linear_model._base import SPARSE_INTERCEPT_DECAY
from sklearn_upgrade.linear_model._stochastic_gradient import DEFAULT_EPSILON
