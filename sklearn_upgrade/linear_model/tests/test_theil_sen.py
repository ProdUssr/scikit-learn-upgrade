"""
Testing for Theil-Sen module (sklearn_upgrade.linear_model.theil_sen)
"""
...
from sklearn_upgrade.linear_model import LinearRegression, TheilSenRegressor
from sklearn_upgrade.linear_model._theil_sen import (
    _breakdown_point,
    _modified_weiszfeld_step,
    _spatial_median,
)
from sklearn_upgrade.utils._testing import assert_almost_equal
