...
from sklearn_upgrade._loss import HalfMultinomialLoss
from sklearn_upgrade.base import clone
from sklearn_upgrade.datasets import load_iris, make_classification, make_low_rank_matrix
from sklearn_upgrade.exceptions import ConvergenceWarning
from sklearn_upgrade.linear_model import LogisticRegression, LogisticRegressionCV, SGDClassifier
from sklearn_upgrade.linear_model._logistic import (
    _log_reg_scoring_path,
    _logistic_regression_path,
)
from sklearn_upgrade.metrics import brier_score_loss, get_scorer, log_loss
...
from sklearn_upgrade.preprocessing import LabelEncoder, StandardScaler, scale
from sklearn_upgrade.svm import l1_min_c
from sklearn_upgrade.utils import compute_class_weight, shuffle
...
from sklearn_upgrade.utils._testing import _array_api_for_tests, ignore_warnings
from sklearn_upgrade.utils.fixes import _IS_32BIT, COO_CONTAINERS, CSR_CONTAINERS

pytestmark = pytest.mark.filterwarnings(
    "error::sklearn_upgrade.exceptions.ConvergenceWarning:sklearn_upgrade.*"
)
...
@pytest.mark.filterwarnings("error::sklearn_upgrade.exceptions.ConvergenceWarning")
