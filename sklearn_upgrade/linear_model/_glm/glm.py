...
from sklearn_upgrade.base import BaseEstimator, RegressorMixin, _fit_context
from sklearn_upgrade.linear_model._glm._newton_solver import NewtonCholeskySolver, NewtonSolver
...
class _GeneralizedLinearRegressor(RegressorMixin, BaseEstimator):
    ...
    use the loss functions `from sklearn_upgrade._loss` which have the link functions included
