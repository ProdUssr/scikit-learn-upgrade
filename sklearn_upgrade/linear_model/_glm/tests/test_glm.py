...
from sklearn_upgrade._loss import HalfBinomialLoss, HalfPoissonLoss, HalfTweedieLoss
from sklearn_upgrade._loss.link import IdentityLink, LogLink
from sklearn_upgrade.base import clone
from sklearn_upgrade.datasets import make_low_rank_matrix, make_regression
...
from sklearn_upgrade.linear_model._glm import _GeneralizedLinearRegressor
from sklearn_upgrade.linear_model._glm._newton_solver import NewtonCholeskySolver
from sklearn_upgrade.linear_model._linear_loss import LinearModelLoss
from sklearn_upgrade.metrics import d2_tweedie_score, mean_poisson_deviance
...
from sklearn_upgrade.utils._testing import _array_api_for_tests, assert_allclose
...
def test_tags(estimator, value):
    ...
    assert estimator.__sklearn_upgrade_tags__().target_tags.positive_only is value
