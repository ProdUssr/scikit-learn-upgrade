...
from sklearn_upgrade.utils._cython_blas cimport (
    _axpy, _dot, _asum, _gemv, _nrm2, _copy, _scal
)
from sklearn_upgrade.utils._cython_blas cimport ColMajor, Trans, NoTrans
from sklearn_upgrade.utils._typedefs cimport int32_t, uint8_t, uint32_t
from sklearn_upgrade.utils._random cimport our_rand_r
...
message_ridge = (
    ...
    "sklearn_upgrade.linear_model.Ridge/RidgeCV instead."
)
