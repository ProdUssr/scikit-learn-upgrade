...
from sklearn_upgrade.exceptions import ConvergenceWarning
...
from sklearn_upgrade.linear_model._sag import sag_solver
from sklearn_upgrade.metrics import check_scoring, get_scorer, get_scorer_names
from sklearn_upgrade.model_selection import GridSearchCV
from sklearn_upgrade.preprocessing import LabelBinarizer
...
from sklearn_upgrade.utils._param_validation import Interval, StrOptions, validate_params
from sklearn_upgrade.utils.extmath import row_norms, safe_sparse_dot
from sklearn_upgrade.utils.fixes import _sparse_linalg_cg
    ...
    *,
    ...
    solver : {'auto', 'svd', 'cholesky', 'lsqr', 'sparse_cg', \
        ...
        - 'sag' uses a Stochastic Average Gradient descent, and 'saga' uses
          ...
          scaler from sklearn_upgrade.preprocessing.
    ...
    return_intercept : bool, default=False
        ...
        data, use sklearn_upgrade.linear_model._preprocess_data before your regression.
    ...
    :class:`~sklearn_upgrade.svm.LinearSVC`. If an array is passed, penalties are
    ...
    >>> from sklearn_upgrade.linear_model import ridge_regression
...
class Ridge(MultiOutputMixin, RegressorMixin, _BaseRidge):
    ...
    solver : {'auto', 'svd', 'cholesky', 'lsqr', 'sparse_cg', \
        ...
        - 'sag' uses a Stochastic Average Gradient descent, and 'saga' uses
          ...
          'saga' fast convergence is only guaranteed on features with
          approximately the same scale. You can preprocess the data with a
          scaler from :mod:`sklearn_upgrade.preprocessing`.
    ...
    :class:`~sklearn_upgrade.kernel_ridge.KernelRidge` : Kernel ridge regression
...
class RidgeClassifier(_RidgeClassifierMixin, _BaseRidge):
    ...
    alpha : float, default=1.0
        ...
        :class:`~sklearn_upgrade.linear_model.LogisticRegression` or
        :class:`~sklearn_upgrade.svm.LinearSVC`.
    ...
    Examples
    --------
    >>> from sklearn_upgrade.datasets import load_breast_cancer
    >>> from sklearn_upgrade.linear_model import RidgeClassifier
...
class RidgeCV(MultiOutputMixin, RegressorMixin, _BaseRidgeCV):
    ...
    cv : int, cross-validation generator or an iterable, default=None
        ...
        :class:`~sklearn_upgrade.model_selection.StratifiedKFold` is used, else,
        :class:`~sklearn_upgrade.model_selection.KFold` is used.
...
class RidgeClassifierCV(_RidgeClassifierMixin, _BaseRidgeCV):
    ...
    --------
    >>> from sklearn_upgrade.datasets import load_breast_cancer
    >>> from sklearn_upgrade.linear_model import RidgeClassifierCV
    >>> X, y = load_breast_cancer(return_X_y=True)
