...
from sklearn_upgrade.base import RegressorMixin, _fit_context

# mypy error: Module 'sklearn_upgrade.linear_model' has no attribute '_cd_fast'
from sklearn_upgrade.linear_model import _cd_fast as cd_fast  # type: ignore[attr-defined]
from sklearn_upgrade.linear_model._base import (
    MultiOutputLinearModel,
    _pre_fit,
)
from sklearn_upgrade.model_selection import check_cv
from sklearn_upgrade.utils import Bunch, check_array, check_scalar, metadata_routing
from sklearn_upgrade.utils._metadata_requests import (
    MetadataRouter,
    MethodMapping,
    _raise_for_params,
)
...
from sklearn_upgrade.utils.extmath import safe_sparse_dot
from sklearn_upgrade.utils.metadata_routing import _routing_enabled, process_routing
from sklearn_upgrade.utils.parallel import Parallel, delayed
from sklearn_upgrade.utils.sparsefuncs import mean_variance_axis
...
def lasso_path(
    ...
    **params : kwargs
    ...
    sklearn_upgrade.decomposition.sparse_encode : Estimator that can be used to
    ...
    >>> import numpy as np
    >>> from sklearn_upgrade.linear_model import lasso_path
    ...
    >>> # same path
    >>> from sklearn_upgrade.linear_model import lars_path
...
def enet_path(
    ...
    **params : kwargs
    ...
    Examples
    --------
    >>> from sklearn_upgrade.linear_model import enet_path
...
class ElasticNet(RegressorMixin, MultiOutputLinearModel):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.linear_model import ElasticNet
    >>> from sklearn_upgrade.datasets import make_regression
...
class Lasso(ElasticNet):
    ...
    sklearn_upgrade.decomposition.sparse_encode : Sparse coding array estimator.
    ...
    models such as :class:`~sklearn_upgrade.linear_model.LogisticRegression` or
    :class:`~sklearn_upgrade.svm.LinearSVC`.
    ...
    It should not be confused with :class:`~sklearn_upgrade.linear_model.MultiTaskLasso` which
    ...
    Examples
    --------
    >>> from sklearn_upgrade import linear_model
...
class LassoCV(RegressorMixin, LinearModelCV):
    ...
    cv : int, cross-validation generator or iterable, default=None
        ...
        For int/None inputs, :class:`~sklearn_upgrade.model_selection.KFold` is used.
    ...
    search using :class:`~sklearn_upgrade.model_selection.GridSearchCV` with a
    ...
    Examples
    --------
    >>> from sklearn_upgrade.linear_model import LassoCV
    >>> from sklearn_upgrade.datasets import make_regression
...
class ElasticNetCV(RegressorMixin, LinearModelCV):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.linear_model import ElasticNetCV
    >>> from sklearn_upgrade.datasets import make_regression
...
class MultiTaskLassoCV(RegressorMixin, LinearModelCV):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.linear_model import MultiTaskLassoCV
    >>> from sklearn_upgrade.datasets import make_regression
