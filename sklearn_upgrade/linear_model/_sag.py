...
from sklearn_upgrade.linear_model._base import make_dataset
from sklearn_upgrade.linear_model._sag_fast import sag32, sag64
from sklearn_upgrade.utils import check_array
from sklearn_upgrade.utils.extmath import row_norms
from sklearn_upgrade.utils.validation import _check_sample_weight
...
def sag_solver(
    ...
    sklearn_upgrade.preprocessing.StandardScaler on your data before passing it to the
    fit method.
