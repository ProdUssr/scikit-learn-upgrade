...
# mypy error: Module 'sklearn_upgrade.utils' has no attribute 'arrayfuncs'
from sklearn_upgrade.utils import Bunch, arrayfuncs, as_float_array, check_random_state
...
def lars_path(
    ...
    *,
    ...
    sklearn_upgrade.decomposition.sparse_encode : Sparse coding.
...
def lars_path_gram(
    ...
    *,
    ...
    Examples
    --------
    >>> from sklearn_upgrade.linear_model import lars_path_gram
    >>> from sklearn_upgrade.datasets import make_regression
    >>> X, y, true_coef = make_regression(
    ...    n_samples=100, n_features=5, n_informative=2, coef=True, random_state=0
    ... )
...
class LarsCV(Lars):
    ...
    cv : int, cross-validation generator or an iterable, default=None
        ...
        For integer/None inputs, :class:`~sklearn_upgrade.model_selection.KFold` is used.
    ...
    Examples
    --------
    >>> from sklearn_upgrade.linear_model import LarsCV
    >>> from sklearn_upgrade.datasets import make_regression
...
class LassoLarsCV(LarsCV):
    ...
    :class:`~sklearn_upgrade.linear_model.LassoCV` object. However, unlike the
    :class:`~sklearn_upgrade.linear_model.LassoCV`, it find the relevant alphas values
    by itself. In general, because of this property, it will be more stable.
    However, it is more fragile to heavily multicollinear datasets.

    It is more efficient than the :class:`~sklearn_upgrade.linear_model.LassoCV` if
    ...
    Examples
    --------
    >>> from sklearn_upgrade.linear_model import LassoLarsCV
    >>> from sklearn_upgrade.datasets import make_regression
