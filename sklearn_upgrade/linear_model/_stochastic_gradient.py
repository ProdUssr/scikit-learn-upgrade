...
from sklearn_upgrade._loss._loss import CyHalfBinomialLoss, CyHalfSquaredError, CyHuberLoss
...
from sklearn_upgrade.linear_model._sgd_fast import (
    EpsilonInsensitive,
    Hinge,
    ModifiedHuber,
...
from sklearn_upgrade.model_selection import ShuffleSplit, StratifiedShuffleSplit
from sklearn_upgrade.utils import check_random_state, compute_class_weight
...
from sklearn_upgrade.utils.multiclass import _check_partial_fit_first_call
...
class SGDClassifier(BaseSGDClassifier):
    ...
    loss : {'hinge', 'log_loss', 'modified_huber', 'squared_hinge',\
        ...
        - The other losses, 'squared_error', 'huber', 'epsilon_insensitive' and
          ...
          :class:`~sklearn_upgrade.linear_model.SGDRegressor` for a description.
    ...
    See Also
    --------
    sklearn_upgrade.svm.LinearSVC : Linear support vector classification.
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.linear_model import SGDClassifier
    ...
    def predict_proba(self, X):
        ...
        the classifier with
        :class:`~sklearn_upgrade.calibration.CalibratedClassifierCV` instead.
...
class SGDRegressor(BaseSGDRegressor):
    ...
    sklearn_upgrade.svm.SVR : Epsilon-Support Vector Regression.
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.linear_model import SGDRegressor
    >>> from sklearn_upgrade.pipeline import make_pipeline
    >>> from sklearn_upgrade.preprocessing import StandardScaler
...
class SGDOneClassSVM(OutlierMixin, BaseSGD):
    ...
    technique (e.g. `sklearn_upgrade.kernel_approximation.Nystroem`) to obtain results
    similar to `sklearn_upgrade.svm.OneClassSVM` which uses a Gaussian kernel by
    default.
    ...
    See Also
    --------
    sklearn_upgrade.svm.OneClassSVM : Unsupervised Outlier Detection.

    Notes
    -----
    This estimator has a linear complexity in the number of training samples
    and is thus better suited than the `sklearn_upgrade.svm.OneClassSVM`
