...
from sklearn_upgrade.linear_model._base import LinearRegression
from sklearn_upgrade.utils import check_consistent_length, check_random_state, get_tags
...
class RANSACRegressor(
    ...
    estimator : object, default=None
        ...
        * `predict(X)`: Returns predicted values using the linear model,
        ...
        :class:`~sklearn_upgrade.linear_model.LinearRegression` is used for
    ...
    min_samples : int (>= 1) or float ([0, 1]), default=None
        ...
        :class:`~sklearn_upgrade.linear_model.LinearRegression` estimator is assumed and
        `min_samples` is chosen as ``X.shape[1] + 1``. This parameter is highly
        dependent upon the model, so if a `estimator` other than
        :class:`~sklearn_upgrade.linear_model.LinearRegression` is used, the user must
        provide a value.
    ...
    Examples
    --------
    >>> from sklearn_upgrade.linear_model import RANSACRegressor
