...
from sklearn_upgrade.metrics.pairwise import (
    KERNEL_PARAMS,
...
from sklearn_upgrade.utils._indexing import _safe_indexing
...
class PolynomialCountSketch(
    ...
    sklearn_upgrade.metrics.pairwise.kernel_metrics : List of built-in kernels.

    Examples
    --------
    >>> from sklearn_upgrade.kernel_approximation import PolynomialCountSketch
...
class RBFSampler(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    Examples
    --------
    >>> from sklearn_upgrade.kernel_approximation import RBFSampler
    >>> from sklearn_upgrade.linear_model import SGDClassifier
    >>> X = [[0, 0], [1, 1], [1, 0], [0, 1]]
    >>> y = [0, 0, 1, 1]
...
class SkewedChi2Sampler(
    ...
    RBFSampler : Approximate an RBF kernel feature map using random Fourier
        features.
    SkewedChi2Sampler : Approximate feature map for "skewed chi-squared" kernel.
    sklearn_upgrade.metrics.pairwise.chi2_kernel : The exact chi squared kernel.
    sklearn_upgrade.metrics.pairwise.kernel_metrics : List of built-in kernels.
    ...
    Examples
    --------
    >>> from sklearn_upgrade.kernel_approximation import SkewedChi2Sampler
    >>> from sklearn_upgrade.linear_model import SGDClassifier
    >>> X = [[0, 0], [1, 1], [1, 0], [0, 1]]
    >>> y = [0, 0, 1, 1]
...
class AdditiveChi2Sampler(TransformerMixin, BaseEstimator):
    ...
    sklearn_upgrade.metrics.pairwise.additive_chi2_kernel : The exact additive chi
        squared kernel.
    ...
    >>> from sklearn_upgrade.linear_model import SGDClassifier
    >>> from sklearn_upgrade.kernel_approximation import AdditiveChi2Sampler
...
class Nystroem(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    gamma : float, default=None
        ...
        the kernel; see the documentation for sklearn_upgrade.metrics.pairwise.
    ...
    * T. Yang, Y. Li, M. Mahdavi, R. Jin and Z. Zhou
    ...
    Examples
    --------
    >>> from sklearn_upgrade import datasets, svm
