...
from sklearn_upgrade.base import BaseEstimator, ClassifierMixin, _fit_context, clone
from sklearn_upgrade.gaussian_process.kernels import RBF, CompoundKernel, Kernel
from sklearn_upgrade.gaussian_process.kernels import ConstantKernel as C
from sklearn_upgrade.multiclass import OneVsOneClassifier, OneVsRestClassifier
