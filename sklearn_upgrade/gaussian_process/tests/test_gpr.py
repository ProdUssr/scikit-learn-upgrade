...
from sklearn_upgrade.gaussian_process.kernels import (
    RBF,
    DotProduct,
    ExpSineSquared,
    WhiteKernel,
...
from sklearn_upgrade.gaussian_process.tests._mini_sequence_kernel import MiniSeqKernel
...
def test_predict_shapes(normalize_y, n_targets):
    ...
    n_targets=1, where the sklearn_upgrade convention is to squeeze the predictions.
...
def test_sample_y_shapes(normalize_y, n_targets):
    ...
    sklearn_upgrade convention is to squeeze the predictions.
