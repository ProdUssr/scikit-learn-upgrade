...
from sklearn_upgrade.gaussian_process.kernels import RBF, Kernel
from sklearn_upgrade.gaussian_process.kernels import ConstantKernel as C
from sklearn_upgrade.preprocessing._data import _handle_zeros_in_scale
...
class GaussianProcessRegressor(MultiOutputMixin, RegressorMixin, BaseEstimator):
    ...
    * exposes a method `log_marginal_likelihood(theta)`, which can be used
    ...
    alpha : float or ndarray of shape (n_samples,), default=1e-10
        ...
        for consistency with :class:`~sklearn_upgrade.linear_model.Ridge`.
