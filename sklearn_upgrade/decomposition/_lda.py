...
from sklearn_upgrade.decomposition._online_lda_fast import (
    _dirichlet_expectation_1d as cy_dirichlet_expectation_1d,
)
from sklearn_upgrade.decomposition._online_lda_fast import _dirichlet_expectation_2d
from sklearn_upgrade.decomposition._online_lda_fast import mean_change as cy_mean_change
from sklearn_upgrade.utils import check_random_state, gen_batches, gen_even_slices
...
class LatentDirichletAllocation(
    ...
    See Also
    --------
    sklearn_upgrade.discriminant_analysis.LinearDiscriminantAnalysis:
    ...
    Examples
    --------
    >>> from sklearn_upgrade.decomposition import LatentDirichletAllocation
