...
from sklearn_upgrade.decomposition import NMF, MiniBatchNMF, non_negative_factorization
from sklearn_upgrade.decomposition import _nmf as nmf  # For testing internals
...
from sklearn_upgrade.utils.extmath import squared_norm
