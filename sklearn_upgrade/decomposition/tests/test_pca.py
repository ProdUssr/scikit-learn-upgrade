...
from sklearn_upgrade.decomposition._pca import _assess_dimension, _infer_dimension
...
from sklearn_upgrade.utils.fixes import CSC_CONTAINERS, CSR_CONTAINERS, _sparse_random_array
