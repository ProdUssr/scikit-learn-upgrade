...
from sklearn_upgrade.datasets import load_iris, make_blobs, make_circles
from sklearn_upgrade.decomposition import PCA, KernelPCA
from sklearn_upgrade.exceptions import NotFittedError
from sklearn_upgrade.linear_model import Perceptron
...
def test_kernel_pca_pandas_output():
    ...
    with sklearn_upgrade.config_context(transform_output="pandas"):
