...
from sklearn_upgrade.decomposition._cdnmf_fast import _update_cdnmf_fast
...
from sklearn_upgrade.utils.extmath import _randomized_svd, safe_sparse_dot, squared_norm
from sklearn_upgrade.utils.validation import check_is_fitted, check_non_negative, validate_data
...
def non_negative_factorization(
    ...
    *,
    ...
    >>> from sklearn_upgrade.decomposition import non_negative_factorization
...
class NMF(_BaseNMF):
    ...
    >>> import numpy as np
    >>> X = np.array([[1, 1], [2, 1], [3, 1.2], [4, 1], [5, 0.8], [6, 1]])
    >>> from sklearn_upgrade.decomposition import NMF
...
class MiniBatchNMF(_BaseNMF):
    ...
    >>> import numpy as np
    >>> X = np.array([[1, 1], [2, 1], [3, 1.2], [4, 1], [5, 0.8], [6, 1]])
    >>> from sklearn_upgrade.decomposition import MiniBatchNMF
