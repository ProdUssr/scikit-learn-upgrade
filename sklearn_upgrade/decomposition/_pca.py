...
from sklearn_upgrade.decomposition._base import _BasePCA
from sklearn_upgrade.utils import check_random_state
from sklearn_upgrade.utils._arpack import _init_arpack_v0
from sklearn_upgrade.utils._array_api import device, get_namespace
from sklearn_upgrade.utils._param_validation import Interval, RealNotInt, StrOptions
from sklearn_upgrade.utils.extmath import _randomized_svd, fast_logdet, svd_flip
from sklearn_upgrade.utils.sparsefuncs import _implicit_column_offset, mean_variance_axis
...
class PCA(_BasePCA):
    ...
    n_oversamples : int, default=10
        ...
        :func:`~sklearn_upgrade.utils.extmath.randomized_svd` for more details.

        .. versionadded:: 1.1

    power_iteration_normalizer : {'auto', 'QR', 'LU', 'none'}, default='auto'
        Power iteration normalizer for randomized SVD solver.
        Not used by ARPACK. See :func:`~sklearn_upgrade.utils.extmath.randomized_svd`
        for more details.
    ...
    def _fit_truncated(self, X, n_components, xp):
        ...
        # * Update sklearn_upgrade.utils.extmath._incremental_mean_and_var to support array-api
