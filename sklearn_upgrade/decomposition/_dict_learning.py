...
from sklearn_upgrade.linear_model import Lars, Lasso, LassoLars, orthogonal_mp_gram
from sklearn_upgrade.utils import check_array, check_random_state, gen_batches, gen_even_slices
from sklearn_upgrade.utils._param_validation import Interval, StrOptions, validate_params
from sklearn_upgrade.utils.extmath import _randomized_svd, row_norms, svd_flip
from sklearn_upgrade.utils.parallel import Parallel, delayed
from sklearn_upgrade.utils.validation import check_is_fitted, validate_data
...
def _sparse_encode_precomputed(
    ...
    *,
    ...
    if algorithm == "lasso_lars":
        ...
        # sklearn_upgrade.linear_model.coordinate_descent.enet_path has a verbosity
...
def sparse_encode(
    ...
    *,
    ...
    See Also
    --------
    sklearn_upgrade.linear_model.lars_path : Compute Least Angle Regression or Lasso
        path using LARS algorithm.
    sklearn_upgrade.linear_model.orthogonal_mp : Solves Orthogonal Matching Pursuit problems.
    sklearn_upgrade.linear_model.Lasso : Train Linear Model with L1 prior as regularizer.
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.decomposition import sparse_encode
...
def dict_learning_online(
    ...
    *,
    ...
    dict_init : ndarray of shape (n_components, n_features), default=None
        ...
        :func:`~sklearn_upgrade.utils.extmath.randomized_svd`.
    ...
    >>> from sklearn_upgrade.decomposition import dict_learning_online
...
def dict_learning(
    ...
    *,
    ...
    >>> import numpy as np
    >>> from sklearn_upgrade.datasets import make_sparse_coded_signal
    >>> from sklearn_upgrade.decomposition import dict_learning
    >>> X, _, _ = make_sparse_coded_signal(
    ...     n_samples=30, n_components=15, n_features=20, n_nonzero_coefs=10,
    ...     random_state=42,
    ... )
...
class SparseCoder(_BaseSparseCoding, BaseEstimator):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.decomposition import SparseCoder
    >>> X = np.array([[-1, -1, -1], [0, 0, 3]])
    >>> dictionary = np.array(
    ...     [[0, 1, 0],
    ...      [-1, -1, 2],
...
class DictionaryLearning(_BaseSparseCoding, BaseEstimator):
    ...
    fit_algorithm : {'lars', 'cd'}, default='lars'
        * `'lars'`: uses the least angle regression method to solve the lasso
          problem (:func:`~sklearn_upgrade.linear_model.lars_path`);
        * `'cd'`: uses the coordinate descent method to compute the
          Lasso solution (:class:`~sklearn_upgrade.linear_model.Lasso`). Lars will be
    ...
    transform_algorithm : {'lasso_lars', 'lasso_cd', 'lars', 'omp', \
        ...
        - `'lars'`: uses the least angle regression method
          (:func:`~sklearn_upgrade.linear_model.lars_path`);
        - `'lasso_lars'`: uses Lars to compute the Lasso solution.
        - `'lasso_cd'`: uses the coordinate descent method to compute the
          Lasso solution (:class:`~sklearn_upgrade.linear_model.Lasso`). `'lasso_lars'`
    ...
    >>> import numpy as np
    >>> from sklearn_upgrade.datasets import make_sparse_coded_signal
    >>> from sklearn_upgrade.decomposition import DictionaryLearning
...
class MiniBatchDictionaryLearning(_BaseSparseCoding, BaseEstimator):
    ...
    >>> import numpy as np
    >>> from sklearn_upgrade.datasets import make_sparse_coded_signal
    >>> from sklearn_upgrade.decomposition import MiniBatchDictionaryLearning
    >>> X, dictionary, code = make_sparse_coded_signal(
    ...     n_samples=30, n_components=15, n_features=20, n_nonzero_coefs=10,
    ...     random_state=42)
