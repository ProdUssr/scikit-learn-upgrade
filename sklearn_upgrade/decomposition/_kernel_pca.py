...
from sklearn_upgrade.utils.extmath import _randomized_eigsh, svd_flip
...
class KernelPCA(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    def inverse_transform(self, X):
        ...
        .. note:
            :meth:`~sklearn_upgrade.decomposition.fit` internally uses a centered
        ...
        .. note::
            ...
            :class:`~sklearn_upgrade.decomposition.PCA` instead. Unlike
            :class:`~sklearn_upgrade.decomposition.PCA`,
            :class:`~sklearn_upgrade.decomposition.KernelPCA`'s ``inverse_transform``
