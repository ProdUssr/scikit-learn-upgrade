...
from sklearn_upgrade.utils.extmath import _randomized_svd, safe_sparse_dot, svd_flip
...
class TruncatedSVD(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    returned by the vectorizers in :mod:`sklearn_upgrade.feature_extraction.text`. In
    ...
    n_iter : int, default=5
        ...
        :func:`~sklearn_upgrade.utils.extmath.randomized_svd` to handle sparse
        matrices that may have large slowly decaying spectrum.

    n_oversamples : int, default=10
        Number of oversamples for randomized SVD solver. Not used by ARPACK.
        See :func:`~sklearn_upgrade.utils.extmath.randomized_svd` for a complete
        description.
