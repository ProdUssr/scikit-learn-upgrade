...
from sklearn_upgrade.utils import _align_api_if_sparse, check_array, metadata_routing
...
class DictVectorizer(TransformerMixin, BaseEstimator):
    ...
    :class:`~sklearn_upgrade.preprocessing.OneHotEncoder` to complete
    ...
    sklearn_upgrade.preprocessing.OrdinalEncoder : Handles nominal/categorical
