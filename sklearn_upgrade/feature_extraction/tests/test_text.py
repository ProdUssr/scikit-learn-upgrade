...
from sklearn_upgrade.feature_extraction.text import (
    ENGLISH_STOP_WORDS,
    CountVectorizer,
    HashingVectorizer,
    TfidfTransformer,
...
from sklearn_upgrade.utils import _align_api_if_sparse
from sklearn_upgrade.utils._testing import (
    assert_allclose_dense_sparse,
    assert_almost_equal,
    skip_if_32bit,
)
from sklearn_upgrade.utils.fixes import _IS_WASM, CSC_CONTAINERS, CSR_CONTAINERS
...
def test_tfidf_vectorizer_type(vectorizer_dtype, output_dtype, warning_expected):
    X = np.array(["numpy", "scipy", "sklearn_upgrade"])
...
def test_hashing_vectorizer_requires_fit_tag():
    ...
    tags = vectorizer.__sklearn_upgrade_tags__()
