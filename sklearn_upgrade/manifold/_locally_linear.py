...
from sklearn_upgrade.utils.fixes import SCIPY_VERSION_BELOW_1_15, _sparse_eye_array
from sklearn_upgrade.utils.validation import FLOAT_DTYPES, check_is_fitted, validate_data
...
def locally_linear_embedding(
    ...
    *,
    ...
    >>> from sklearn_upgrade.manifold import locally_linear_embedding
...
class LocallyLinearEmbedding(
    ...
    neighbors_algorithm : {'auto', 'brute', 'kd_tree', 'ball_tree'}, \
        ...
        :class:`~sklearn_upgrade.neighbors.NearestNeighbors` instance.
    ...
    --------
    >>> from sklearn_upgrade.datasets import load_digits
    >>> from sklearn_upgrade.manifold import LocallyLinearEmbedding
    >>> X, _ = load_digits(return_X_y=True)
    >>> X.shape
    (1797, 64)
