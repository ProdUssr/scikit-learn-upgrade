...
from sklearn_upgrade.decomposition import KernelPCA
from sklearn_upgrade.metrics.pairwise import _VALID_METRICS
from sklearn_upgrade.neighbors import NearestNeighbors, kneighbors_graph, radius_neighbors_graph
...
from sklearn_upgrade.utils.graph import _fix_connected_components
...
class Isomap(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    metric : str, or callable, default="minkowski"
        ...
        the options allowed by :func:`sklearn_upgrade.metrics.pairwise_distances` for
    ...
    p : float, default=2
        ...
        sklearn_upgrade.metrics.pairwise.pairwise_distances. When p = 1, this is
    ...
    kernel_pca_ : object
        :class:`~sklearn_upgrade.decomposition.KernelPCA` object used to implement the
        embedding.

    nbrs_ : sklearn_upgrade.neighbors.NearestNeighbors instance
    ...
    >>> from sklearn_upgrade.manifold import Isomap
