...
from sklearn_upgrade.datasets import load_digits, load_iris, make_blobs
from sklearn_upgrade.manifold import ClassicalMDS
from sklearn_upgrade.manifold import _mds as mds
...
def test_normalized_stress_auto(metric, monkeypatch):
    ...
    monkeypatch.setattr("sklearn_upgrade.manifold._mds._smacof_single", mock)
