...
from sklearn_upgrade.manifold import SpectralEmbedding, _spectral_embedding, spectral_embedding
from sklearn_upgrade.manifold._spectral_embedding import (
    _graph_connected_component,
    _graph_is_connected,
)
from sklearn_upgrade.metrics import normalized_mutual_info_score, pairwise_distances
from sklearn_upgrade.metrics.pairwise import rbf_kernel
from sklearn_upgrade.neighbors import NearestNeighbors
from sklearn_upgrade.utils._testing import assert_array_almost_equal, assert_array_equal
