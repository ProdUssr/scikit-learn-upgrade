...
# mypy error: Module 'sklearn_upgrade.manifold' has no attribute '_utils'
# mypy error: Module 'sklearn_upgrade.manifold' has no attribute '_barnes_hut_tsne'
from sklearn_upgrade.manifold import _barnes_hut_tsne, _utils  # type: ignore[attr-defined]
from sklearn_upgrade.metrics.pairwise import _VALID_METRICS, pairwise_distances
from sklearn_upgrade.neighbors import NearestNeighbors
from sklearn_upgrade.utils import _align_api_if_sparse, check_random_state
...
from sklearn_upgrade.utils.validation import _num_samples, check_non_negative, validate_data
...
def trustworthiness(X, X_embedded, *, n_neighbors=5, metric="euclidean"):
    ...
    metric : str or callable, default='euclidean'
        ...
        `sklearn_upgrade.pairwise.pairwise_distances` and metrics listed in
        `sklearn_upgrade.metrics.pairwise.PAIRWISE_DISTANCE_FUNCTIONS`. Note that the
        "cosine" metric uses :func:`~sklearn_upgrade.metrics.pairwise.cosine_distances`.
    ...
    >>> from sklearn_upgrade.decomposition import PCA
    >>> from sklearn_upgrade.manifold import trustworthiness
...
class TSNE(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    See Also
    --------
    sklearn_upgrade.decomposition.PCA : Principal component analysis that is a linear
        dimensionality reduction method.
    sklearn_upgrade.decomposition.KernelPCA : Non-linear dimensionality reduction using
        kernels and PCA.
    ...
    Notes
    -----
    For an example of using :class:`~sklearn_upgrade.manifold.TSNE` in combination with
    :class:`~sklearn_upgrade.neighbors.KNeighborsTransformer` see
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.manifold import TSNE
