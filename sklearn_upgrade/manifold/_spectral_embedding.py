...
from sklearn_upgrade.neighbors import NearestNeighbors, kneighbors_graph
from sklearn_upgrade.utils import check_array, check_random_state, check_symmetric
from sklearn_upgrade.utils._arpack import _init_arpack_v0
from sklearn_upgrade.utils._param_validation import Interval, StrOptions, validate_params
from sklearn_upgrade.utils.extmath import _deterministic_vector_sign_flip
from sklearn_upgrade.utils.fixes import _sparse_eye_array, parse_version, sp_version
from sklearn_upgrade.utils.fixes import laplacian as csgraph_laplacian
...
def spectral_embedding(
    ...
    * :doi:`"Toward the Optimal Preconditioned Eigensolver: Locally Optimal
    ...
    >>> from sklearn_upgrade.neighbors import kneighbors_graph
    >>> from sklearn_upgrade.manifold import spectral_embedding
...
class SpectralEmbedding(BaseEstimator):
    ...
    --------
    >>> from sklearn_upgrade.datasets import load_digits
    >>> from sklearn_upgrade.manifold import SpectralEmbedding
    >>> X, _ = load_digits(return_X_y=True)
    >>> X.shape
    (1797, 64)
