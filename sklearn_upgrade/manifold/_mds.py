...
from sklearn_upgrade.manifold import ClassicalMDS
from sklearn_upgrade.metrics import euclidean_distances, pairwise_distances
...
def smacof(
    ...
    *,
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_upgrade.manifold import smacof
    >>> from sklearn_upgrade.metrics import euclidean_distances
...
class MDS(BaseEstimator):
    ...
    metric : str or callable, default='euclidean'
        ...
        listed in :func:`sklearn_upgrade.metrics.pairwise.distance_metrics`
    ...
    >>> from sklearn_upgrade.manifold import MDS
