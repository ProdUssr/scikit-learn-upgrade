...
from sklearn_upgrade.base import BaseEstimator, RegressorMixin, _fit_context, clone
...
from sklearn_upgrade.utils._param_validation import HasMethods
...
class TransformedTargetRegressor(RegressorMixin, BaseEstimator):
    ...
    such as the :class:`~sklearn_upgrade.preprocessing.QuantileTransformer` or as a
    ...
    regressor : object, default=None
        ...
        :class:`~sklearn_upgrade.base.RegressorMixin`. This regressor will
        automatically be cloned each time prior to fitting. If `regressor is
        None`, :class:`~sklearn_upgrade.linear_model.LinearRegression` is created and used.

    transformer : object, default=None
        Estimator object such as derived from
        :class:`~sklearn_upgrade.base.TransformerMixin`. Cannot be set at the same time
    ...
    See Also
    --------
    sklearn_upgrade.preprocessing.FunctionTransformer : Construct a transformer from an
        arbitrary callable.
    ...
    >>> import numpy as np
    >>> from sklearn_upgrade.linear_model import LinearRegression
    >>> from sklearn_upgrade.compose import TransformedTargetRegressor
