"""
The :mod:`sklearn_upgrade.compose._column_transformer` module implements utilities
...
from sklearn_upgrade.pipeline import _fit_transform_one, _name_estimators, _transform_one
...
class ColumnTransformer(TransformerMixin, _BaseComposition):
    ...
    transformers_ : list
        ...
        :class:`~sklearn_upgrade.preprocessing.FunctionTransformer`. In case there were
    ...
    named_transformers_ : :class:`~sklearn_upgrade.utils.Bunch`
...
def make_column_transformer(
    ...
    *transformers : tuples
    ...
    Examples
    --------
    >>> from sklearn_upgrade.preprocessing import StandardScaler, OneHotEncoder
...
class make_column_selector:
    ...
    >>> from sklearn_upgrade.preprocessing import StandardScaler, OneHotEncoder
    >>> from sklearn_upgrade.compose import make_column_transformer
    >>> from sklearn_upgrade.compose import make_column_selector
    >>> import numpy as np
    >>> import pandas as pd  # doctest: +SKIP
