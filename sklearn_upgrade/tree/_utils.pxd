...
from sklearn_upgrade.neighbors._quad_tree cimport Cell
from sklearn_upgrade.utils._typedefs cimport float32_t, float64_t, intp_t, uint8_t, int32_t, uint32_t
