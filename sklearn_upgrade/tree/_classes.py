...
from sklearn_upgrade.tree import _criterion, _splitter, _tree
from sklearn_upgrade.tree._criterion import Criterion
from sklearn_upgrade.tree._splitter import Splitter
from sklearn_upgrade.tree._tree import (
...
from sklearn_upgrade.utils._param_validation import Hidden, Interval, RealNotInt, StrOptions
...
class BaseDecisionTree(MultiOutputMixin, BaseEstimator, metaclass=ABCMeta):
    ...
    def _support_missing_values(self, X):
        return (
            not issparse(X)
            and self.__sklearn_upgrade_tags__().input_tags.allow_nan
    ...
    def cost_complexity_pruning_path(self, X, y, sample_weight=None):
        ...
        Returns
        -------
        ccp_path : :class:`~sklearn_upgrade.utils.Bunch`
...
class DecisionTreeClassifier(ClassifierMixin, BaseDecisionTree):
    ...
    tree_ : Tree instance
        ...
        ``help(sklearn_upgrade.tree._tree.Tree)`` for attributes of Tree object and
...
class ExtraTreeClassifier(DecisionTreeClassifier):
    ...
    sklearn_upgrade.ensemble.ExtraTreesClassifier : An extra-trees classifier.
    sklearn_upgrade.ensemble.ExtraTreesRegressor : An extra-trees regressor.
    sklearn_upgrade.ensemble.RandomForestClassifier : A random forest classifier.
    sklearn_upgrade.ensemble.RandomForestRegressor : A random forest regressor.
    sklearn_upgrade.ensemble.RandomTreesEmbedding : An ensemble of
    ...
    >>> from sklearn_upgrade.ensemble import BaggingClassifier
    >>> from sklearn_upgrade.tree import ExtraTreeClassifier
...
class ExtraTreeRegressor(DecisionTreeRegressor):
    ...
    >>> from sklearn_upgrade.datasets import load_diabetes
    >>> from sklearn_upgrade.model_selection import train_test_split
    >>> from sklearn_upgrade.ensemble import BaggingRegressor
    >>> from sklearn_upgrade.tree import ExtraTreeRegressor
    >>> X, y = load_diabetes(return_X_y=True)
    >>> X_train, X_test, y_train, y_test = train_test_split(
    ...     X, y, random_state=0)
