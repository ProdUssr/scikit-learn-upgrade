...
from sklearn_upgrade.tree._reingold_tilford import Tree, buchheim
...
from sklearn_upgrade.utils.validation import check_array, check_is_fitted
...
def export_text(
    ...
    *,
    ...
    >>> from sklearn_upgrade.tree import export_text
    >>> iris = load_iris()
    >>> X = iris['data']
    >>> y = iris['target']
