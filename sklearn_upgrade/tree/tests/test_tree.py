"""
Testing for the tree module (sklearn_upgrade.tree).
"""
...
from sklearn_upgrade import clone, datasets, tree
...
from sklearn_upgrade.random_projection import _sparse_random_matrix
...
from sklearn_upgrade.tree._classes import (
    CRITERIA_CLF,
    CRITERIA_REG,
    DENSE_SPLITTERS,
    SPARSE_SPLITTERS,
)
from sklearn_upgrade.tree._criterion import _py_precompute_absolute_errors
from sklearn_upgrade.tree._partitioner import _py_sort
...
from sklearn_upgrade.tree._tree import Tree as CythonTree
from sklearn_upgrade.utils import compute_sample_weight
...
def test_almost_constant_feature(tree_cls):
    ...
    # FEATURE_THRESHOLD=1e-7 is defined in sklearn_upgrade/tree/_partitioner.pxd but not
...
def test_realloc():
    from sklearn_upgrade.tree._utils import _realloc_test
...
def test_poisson_vs_mse():
    ...
    # sklearn_upgrade/ensemble/_hist_gradient_boosting/tests/test_gradient_boosting.py
...
def get_different_bitness_node_ndarray(node_ndarray):
    ...
    # field names in Node struct with SIZE_t types (see sklearn_upgrade/tree/_tree.pxd)
